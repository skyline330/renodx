...
void main(
  ...
  r0.xyzw = cb0[169].xyxy * float4(-4.09528494, -4.09528494, -2.22262812, -2.22262812) + v1.xyxy;
  ...
  r1.xyzw = cb0[169].xyxy * float4(-0.437803, -0.437803, 1.32076705, 1.32076705) + v1.xyxy;
  ...
  r1.xyzw = cb0[169].xyxy * float4(3.14797401, 3.14797401, 5, 5) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
