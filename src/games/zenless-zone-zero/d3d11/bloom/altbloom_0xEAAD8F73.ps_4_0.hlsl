...
void main(
  ...
  r0.xyzw = cb0[173].xyxy * float4(-18.3031006, -18.3031006, -16.3224392, -16.3224392) + v1.xyxy;
  ...
  r1.xyzw = cb0[173].xyxy * float4(-14.3424101, -14.3424101, -12.3629599, -12.3629599) + v1.xyxy;
  ...
  r1.xyzw = cb0[173].xyxy * float4(-10.3840103, -10.3840103, -8.40551472, -8.40551472) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(-6.42738485, -6.42738485, -4.44954205, -4.44954205) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(-2.47190189, -2.47190189, -0.494374692, -0.494374692) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(1.48312998, 1.48312998, 3.46070194, 3.46070194) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(5.43843317, 5.43843317, 7.41640902, 7.41640902) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(9.3947134, 9.3947134, 11.3734198, 11.3734198) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(13.3526201, 13.3526201, 15.3323498, 15.3323498) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[173].xyxy * float4(17.3126907, 17.3126907, 19, 19) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
