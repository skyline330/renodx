...
void main(
  ...
  r0.xyzw = cb0[168].xyxy * float4(-11.2270498, -11.2270498, -9.26659012, -9.26659012) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(-7.31025219, -7.31025219, -5.35757923, -5.35757923) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(-3.40785503, -3.40785503, -1.46013796, -1.46013796) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[168].xyxy * float4(0.486687511, 0.486687511, 2.4338119, 2.4338119) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[168].xyxy * float4(4.38240194, 4.38240194, 6.33349609, 6.33349609) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[168].xyxy * float4(8.28792858, 8.28792858, 10.2462902, 10.2462902) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xy = cb0[168].xy * float2(12, 12) + v1.xy;
