...
void main(
  ...
  r0.xyzw = cb0[169].xyxy * float4(-9.19568539, -9.19568539, -7.24677086, -7.24677086) + v1.xyxy;
  ...
  r1.xyzw = cb0[169].xyxy * float4(-5.30611801, -5.30611801, -3.37267494, -3.37267494) + v1.xyxy;
  ...
  r1.xyzw = cb0[169].xyxy * float4(-1.444435, -1.444435, 0.481410086, 0.481410086) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  ...
  r1.xyzw = cb0[169].xyxy * float4(2.40806508, 2.40806508, 4.33859921, 4.33859921) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  ...
  r1.xyzw = cb0[169].xyxy * float4(6.275455, 6.275455, 8.22016716, 8.22016716) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  ...
  r1.xy = cb0[169].xy * float2(10, 10) + v1.xy;
