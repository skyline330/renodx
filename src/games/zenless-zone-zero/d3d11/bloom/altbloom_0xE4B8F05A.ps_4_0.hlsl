...
// Version 2.7 - Bloom shader (character menu)
...
void main(
  ...
  r0.xyzw = cb0[168].xyxy * float4(-4.09528494, -4.09528494, -2.22262812, -2.22262812) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(-0.437803, -0.437803, 1.32076705, 1.32076705) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(3.14797401, 3.14797401, 5, 5) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
