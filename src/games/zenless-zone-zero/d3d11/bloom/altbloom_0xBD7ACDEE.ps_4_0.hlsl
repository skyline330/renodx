...
void main(
  ...
  r0.xyzw = cb0[168].xyxy * float4(-5.11701679, -5.11701679, -3.21651697, -3.21651697) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(-1.36559105, -1.36559105, 0.454197288, 0.454197288) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(2.28523707, 2.28523707, 4.16063213, 4.16063213) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xy = cb0[168].xy * float2(6, 6) + v1.xy;
