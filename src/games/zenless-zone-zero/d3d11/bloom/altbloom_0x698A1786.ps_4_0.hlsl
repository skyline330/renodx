...
// Version 2.7 - Bloom shader (game world)

// ---- Created with 3Dmigoto v1.4.1 on Thu Mar 26 19:56:18 2026
...
void main(
  ...
  r0.xyzw = cb0[168].xyxy * float4(-10.2120304, -10.2120304, -8.25679779, -8.25679779) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(-6.30732918, -6.30732918, -4.36294699, -4.36294699) + v1.xyxy;
  ...
  r1.xyzw = cb0[168].xyxy * float4(-2.42249203, -2.42249203, -0.484377503, -0.484377503) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[168].xyxy * float4(1.45325398, 1.45325398, 3.39231896, 3.39231896) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[168].xyxy * float4(5.33456421, 5.33456421, 7.28137398, 7.28137398) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  ...
  r1.xyzw = cb0[168].xyxy * float4(9.23367119, 9.23367119, 11, 11) + v1.xyxy;
  r1.xyzw = max(v2.xyxy, r1.xyzw);
  r1.xyzw = min(v2.zwzw, r1.xyzw);
  r2.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
  r1.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  r0.xyzw = r2.xyzw * float4(0.00116418698, 0.00116418698, 0.00116418698, 0.00116418698) + r0.xyzw;
  o0.xyzw = r1.xyzw * float4(7.32016633e-05, 7.32016633e-05, 7.32016633e-05, 7.32016633e-05) + r0.xyzw;
