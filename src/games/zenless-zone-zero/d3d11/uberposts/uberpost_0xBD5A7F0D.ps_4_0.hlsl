...
// Uberpost - version 2.5 - Trigger Aftershock (Shiyu Defense)

// ---- Created with 3Dmigoto v1.4.1 on Tue Dec 30 01:07:45 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.y != 0) {
    ...
    r3.xyzw = t10.Sample(s8_s, r2.yz).xyzw;
  ...
  r3.xyz = r3.zzz * cb1[27].xyz + r3.xyw;
  ...
  if (r0.x != 0) {
    ...
    r7.xyzw = t4.Sample(s3_s, r6.xy).xyzw;
    ...
    if (r4.y != 0) {
      ...
      r8.xyzw = t5.Sample(s0_s, r4.xy).xyzw;
  ...
  float vignette_value = lerp(1.0, r0.x, injectedData.fxVignetteStrength);
  ...
  */
  ...
  r1.yzw = renodx::lut::Sample(t2, lut_config, untonemapped);

  /*
  r1.yzw = r3.zxy * float3(5.55555582,5.55555582,5.55555582) + float3(0.0479959995,0.0479959995,0.0479959995);
  r1.yzw = log2(r1.yzw);
  ...
  */
  ...
  r2.xw = r2.xw + r2.yz;
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t9.Sample(s7_s, r2.xw).xyzw;
  ...
  r2.xyzw = t6.Sample(s4_s, r2.xw).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r2.xyzw = t7.Sample(s5_s, r4.xy).xyzw;
