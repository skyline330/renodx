...
// Uberpost - version 2.7 - VR Training - Black/white portion of battle intro

// ---- Created with 3Dmigoto v1.4.1 on Tue Mar 24 17:44:46 2026
...
void main(
  ...
  r0.xyz = applyUserToneMap(untonemapped, cb1[0], t3, s0_s);

  // Original lutsampling
  /*
