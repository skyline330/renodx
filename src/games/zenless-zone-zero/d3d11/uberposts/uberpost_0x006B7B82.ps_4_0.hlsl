...
// Uberpost - version 2.5 - Ye Shunguang Ultimate: Cleaving Heavens

// ---- Created with 3Dmigoto v1.4.1 on Tue Dec 30 02:05:57 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r0.y != 0) {
    ...
    r0.xyzw = t0.Sample(s0_s, r1.zw).xyzw;
  }
  ...
  if (r0.w != 0) {
    ...
    if (r1.y != 0) {
      ...
      r4.xyzw = t5.Sample(s0_s, r1.xy).xyzw;
