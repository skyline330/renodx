...
// Uberpost - version 2.5 - Hollow Zero Mission Complete

// ---- Created with 3Dmigoto v1.4.1 on Tue Dec 30 01:26:34 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r3.xyzw = t5.Sample(s3_s, r1.yz).xyzw;
  r1.y = -0.5 + r3.x;
  r1.y = r1.y + r1.y;
  ...
  r5.xyzw = t5.Sample(s3_s, r5.zw).xyzw;
  r3.xw = float2(0.5,0);
  r7.xyzw = t5.Sample(s3_s, r3.xy).yzxw;
  r1.x = r4.w * r4.w;
  r1.x = r4.w * r1.x;
  ...
  if (r3.y != 0) {
    ...
    r4.zw = frac(r4.zw);
    r3.xy = r4.zw + r3.xy;
    r6.xyzw = t6.Sample(s4_s, r3.xy).xyzw;
  ...
  r0.zw = cb0[200].xy * r0.zw;
  r4.xyzw = t9.Sample(s1_s, r0.zw).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r4.xyzw = t7.Sample(s5_s, r3.xy).xyzw;
    ...
    if (r2.y != 0) {
      ...
      r6.xyzw = t8.Sample(s0_s, r0.zw).xyzw;
