...
// Uberpost - version 2.5 - Signal Search - Agent Contracted transition

// ---- Created with 3Dmigoto v1.4.1 on Tue Dec 30 02:15:11 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.w != 0) {
    ...
    r6.xyzw = t5.Sample(s3_s, r6.xy).xyzw;
    ...
    if (r5.y != 0) {
      ...
      r8.xyzw = t6.Sample(s0_s, r5.xy).xyzw;
  ...
  */
  ...
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t10.Sample(s7_s, r5.xy).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r3.xyzw = t9.Sample(s6_s, r0.xy).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r3.xyzw, icb[r0.x+0].xyzw);
  r3.xyzw = t7.Sample(s4_s, r5.xy).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t8.Sample(s5_s, r5.zw).xyzw;
