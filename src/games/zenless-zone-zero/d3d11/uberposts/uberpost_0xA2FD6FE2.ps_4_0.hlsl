...
// Uberpost - version 2.7 - Shiyu Defense - Aftershock

// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 27 20:02:39 2026
...
void main(
  ...
  r3.xyzw = t1.Sample(s0_s, r2.zw).xyzw;
  r1.xy = r1.xy + r0.yz;
  ...
  if (r0.x != 0) {
    ...
    r4.xyzw = t5.Sample(s3_s, r3.xy).xyzw;
    ...
    if (r1.y != 0) {
      ...
      r5.xyzw = t6.Sample(s0_s, r0.xw).xyzw;
