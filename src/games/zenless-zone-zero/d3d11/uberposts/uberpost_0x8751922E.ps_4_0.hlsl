...
// Uberpost - version 2.5 - Yixuan Nimbus Step (Hollow Zero)

// ---- Created with 3Dmigoto v1.4.1 on Tue Dec 30 17:16:58 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r1.w != 0) {
    ...
    r7.xyzw = t5.Sample(s3_s, r6.xy).xyzw;
    ...
    if (r2.w != 0) {
      ...
      r8.xyzw = t6.Sample(s0_s, r2.zw).xyzw;
