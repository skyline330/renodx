...
// Uberpost - version 2.7 - VR Training - Wipeout screen

// ---- Created with 3Dmigoto v1.4.1 on Thu Mar 26 23:02:23 2026
...
void main(
  ...
  r4.xyzw = t8.Sample(s1_s, r0.zw).xyzw;
  ...
  if (r0.z != 0) {
    ...
    if (r2.y != 0) {
      ...
      r6.xyzw = t7.Sample(s0_s, r0.zw).xyzw;
