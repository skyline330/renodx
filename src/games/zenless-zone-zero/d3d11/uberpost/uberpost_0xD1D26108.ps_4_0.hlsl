...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t14.Sample(s10_s, r1.yz).xyzw;
  ...
  r1.w = cmp(0 < cb1[11].w);
  if (r1.w != 0) {
    r2.xyzw = t4.Sample(s2_s, v1.xy).xyzw;
  ...
  r6.xyzw = t5.Sample(s3_s, r2.zw).xyzw;
  r2.z = -0.5 + r6.x;
  r2.z = r2.z + r2.z;
  ...
  r8.xyzw = t5.Sample(s3_s, r8.zw).xyzw;
  r10.xyzw = t5.Sample(s3_s, r3.zw).yzxw;
  r1.w = r6.w * r6.w;
  r1.w = r6.w * r1.w;
  ...
  if (r2.z != 0) {
    ...
    r9.xyzw = t6.Sample(s4_s, r3.zw).xyzw;
  ...
  if (r2.w != 0) {
    ...
    r3.zw = frac(r3.zw);
    r2.zw = r3.zw + r2.zw;
    r9.xyzw = t6.Sample(s4_s, r2.zw).xyzw;
  ...
  r2.xyzw = t9.Sample(s1_s, r2.xy).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r5.xyzw = t7.Sample(s5_s, r5.xy).xyzw;
    ...
    if (r3.w != 0) {
      ...
      r7.xyzw = t8.Sample(s0_s, r3.zw).xyzw;
  ...
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t13.Sample(s9_s, r5.xy).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r3.xyzw = t12.Sample(s8_s, r0.xy).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r3.xyzw, icb[r0.x + 0].xyzw);
  r3.xyzw = t10.Sample(s6_s, r5.xy).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t11.Sample(s7_s, r5.zw).xyzw;
