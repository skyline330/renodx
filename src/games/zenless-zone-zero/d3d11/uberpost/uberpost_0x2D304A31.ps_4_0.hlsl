...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t15.Sample(s10_s, r1.yz).xyzw;
  ...
  r1.w = cmp(0 < cb1[11].w);
  if (r1.w != 0) {
    r2.xyzw = t5.Sample(s2_s, v1.xy).xyzw;
  ...
  r6.xyzw = t6.Sample(s3_s, r2.zw).xyzw;
  r2.z = -0.5 + r6.x;
  r2.z = r2.z + r2.z;
  ...
  r9.xyzw = t6.Sample(s3_s, r8.xy).xyzw;
  r8.xyzw = t6.Sample(s3_s, r8.zw).xyzw;
  r10.xyzw = t6.Sample(s3_s, r3.zw).yzxw;
  r1.w = r6.w * r6.w;
  r1.w = r6.w * r1.w;
  ...
  if (r2.z != 0) {
    ...
    r9.xyzw = t7.Sample(s4_s, r3.zw).xyzw;
  ...
  if (r2.w != 0) {
    ...
    r3.zw = frac(r3.zw);
    r2.zw = r3.zw + r2.zw;
    r9.xyzw = t7.Sample(s4_s, r2.zw).xyzw;
    r8.xyz = r9.yyy * r8.xyz;
  }
  r1.w = cmp(0.5 < cb1[24].w);
  if (r1.w != 0) {
    ...
    r9.xyzw = t1.Sample(s0_s, r3.zw).xyzw;
    r3.zw = v1.xy + r5.zw;
    r3.zw = r7.yy * r6.xy + r3.zw;
    r3.zw = r2.zw * cb1[26].ww + r3.zw;
    r10.xyzw = t1.Sample(s0_s, r3.zw).xyzw;
    r3.zw = v1.xy + r2.xy;
    r3.zw = r7.zz * r6.xy + r3.zw;
    r2.zw = r2.zw * cb1[27].ww + r3.zw;
    r11.xyzw = t1.Sample(s0_s, r2.zw).xyzw;
    r9.yzw = cb1[26].xyz * r10.yyy;
    r9.xyz = r9.xxx * cb1[25].xyz + r9.yzw;
    r9.xyz = r11.zzz * cb1[27].xyz + r9.xyz;
    r10.xyzw = t1.Sample(s0_s, r3.xy).wxyz;
  } else {
    r2.zw = v1.xy + r5.xy;
    r2.zw = r7.xx * r6.xy + r2.zw;
    r11.xyzw = t1.Sample(s0_s, r2.zw).xyzw;
    r2.zw = v1.xy + r5.zw;
    r2.zw = r7.yy * r6.xy + r2.zw;
    r5.xyzw = t1.Sample(s0_s, r2.zw).xyzw;
    r2.xy = v1.xy + r2.xy;
    r2.xy = r7.zz * r6.xy + r2.xy;
    r9.xyzw = t1.Sample(s0_s, r2.xy).xyzw;
    r10.xyzw = t1.Sample(s0_s, r3.xy).wxyz;
    r9.x = r11.x;
    r9.y = r5.y;
  }
  r2.xy = cb1[23].xy * v1.xy;
  r2.xy = cb0[206].xy * r2.xy;
  r2.xyzw = t10.Sample(s1_s, r2.xy).xyzw;
  ...
  r1.w = 1 + -cb1[23].z;
  r2.xyz = r2.xyz * r1.www + cb1[23].zzz;
  r2.xyz = r9.xyz * r2.xyz + r8.xyz;
  ...
  if (r1.w != 0) {
    ...
    r6.xyz = log2(abs(r5.xyz));
    r6.xyz = float3(0.333333343, 0.333333343, 0.333333343) * r6.xyz;
    r6.xyz = exp2(r6.xyz);
    r6.xyz = r6.xyz * float3(1.49380159, 1.49380159, 1.49380159) + -r5.xyz;
    r7.xyz = cmp(r5.xyz >= float3(0.300000012, 0.300000012, 0.300000012));
    ...
    r6.xyz = r10.xxx * r6.xyz + r5.xyz;
    r6.xyz = r2.www ? r6.xyz : r5.xyz;
    if (r3.w != 0) {
      r3.zw = r3.xy * cb1[20].xy + cb1[20].zw;
      r7.xyzw = t9.Sample(s0_s, r3.zw).xyzw;
    ...
    r1.w = r6.x + r6.y;
    r1.w = r1.w + r6.z;
    o0.w = saturate(r1.w * 0.333299994 + r10.x);
  } else {
    o0.w = r10.x;
  }
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r2.xyz = UberpostArriLutSample(r2.xyz, t3, s0_s);
  } else {
  ...
  r3.zw = r3.zw + r1.yz;
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t14.Sample(s9_s, r3.zw).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r6.xyzw = t13.Sample(s8_s, r0.xy).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r6.xyzw, icb[r0.x + 0].xyzw);
  r3.xyzw = t11.Sample(s6_s, r3.zw).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t12.Sample(s7_s, r5.zw).xyzw;
