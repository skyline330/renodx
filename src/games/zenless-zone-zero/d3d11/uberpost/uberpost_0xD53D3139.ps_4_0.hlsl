...
void main(
  ...
  if (r0.x != 0) {
    ...
    r0.zw = v1.xy + r0.zw;
    r3.xyzw = t0.SampleBias(s0_s, r0.zw, cb0[61].x).zxyw;
    r3.y = r2.x;
    r3.z = r1.y;
  } else {
    r0.xy = v1.xy;
    r3.xyzw = t0.SampleBias(s0_s, v1.xy, cb0[61].x).zxyw;
  }
  r1.xyzw = t0.SampleBias(s0_s, r0.xy, cb0[61].x).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r0.z = r1.z ? r0.z : r0.w;
    r0.z = r0.z * 2 + -1;
    r2.x = cb1[28].z * r0.z + r0.x;
    r0.z = cb0[138].x * cb0[138].w;
    r0.w = abs(cb1[29].y) + r2.x;
    r1.x = cb1[29].y * r0.y;
    r0.w = r0.w * r0.z + -r1.x;
    ...
    r2.xyzw = t4.SampleBias(s3_s, r2.xy, cb0[61].x).xyzw;
