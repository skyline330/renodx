...
void main(
  ...
  r0.z = cmp(0 < cb1[11].w);
  if (r0.z != 0) {
    r1.xyzw = t6.Sample(s2_s, r0.xy).xyzw;
    r2.xy = float2(0.100000001, 0.100000001) * r1.xy;
    r1.xy = r1.xy * float2(0.100000001, 0.100000001) + v1.xy;
    r1.zw = r2.xy * r1.zz;
    r1.zw = cb1[11].ww * r1.zw;
    r3.xyzw = r1.zwzw * cb1[11].xxyy + r2.xyxy;
    r1.zw = r1.zw * cb1[11].zz + r2.xy;
  } else {
    r1.xy = v1.xy;
  ...
  if (r0.z != 0) {
    ...
    r3.xyzw = t7.Sample(s3_s, r3.xy).xyzw;
    r4.yzw = log2(abs(r3.xyz));
    r4.yzw = float3(0.333333343, 0.333333343, 0.333333343) * r4.yzw;
    r4.yzw = exp2(r4.yzw);
    r4.yzw = r4.yzw * float3(1.49380159, 1.49380159, 1.49380159) + -r3.xyz;
    r5.xyz = cmp(r3.xyz >= float3(0.300000012, 0.300000012, 0.300000012));
    r5.xyz = r5.xyz ? float3(1, 1, 1) : 0;
    r4.yzw = float3(-0.699999988, -0.699999988, -0.699999988) + r4.yzw;
    ...
    if (r1.w != 0) {
      ...
      r4.yzw = r5.xyz * r3.xyz + r4.yzw;
    }
    r2.xyz = r4.yzw + r2.xyz;
    r0.z = r4.y + r4.z;
    r0.z = r0.z + r4.w;
    o0.w = saturate(r0.z * 0.333299994 + r4.x);
  } else {
    o0.w = r4.x;
  }
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r1.xyz = UberpostArriLutSample(r2.xyz, t4, s0_s);
  } else {
    ...
    r4.y = 0;
    r1.yz = r4.xy + r2.xz;
    r2.xyzw = t4.SampleLevel(s0_s, r1.yz, 0).xyzw;
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    ...
    if (r0.w != 0) {
      r1.xyzw = t5.Sample(s0_s, v1.xy).xyzw;
