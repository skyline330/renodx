...
void main(
  ...
  r0.x = cmp(0 < cb1[11].w);
  if (r0.x != 0) {
    r0.xyzw = t3.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  r3.xyzw = t4.SampleBias(s3_s, r1.yz, cb0[61].x).xyzw;
  r1.y = -0.5 + r3.x;
  r1.y = r1.y + r1.y;
  ...
  r6.xyzw = t4.SampleBias(s3_s, r5.xy, cb0[61].x).xyzw;
  r5.xyzw = t4.SampleBias(s3_s, r5.zw, cb0[61].x).xyzw;
  r3.xw = float2(0.5, 0);
  r7.xyzw = t4.SampleBias(s3_s, r3.xy, cb0[61].x).yzxw;
  r1.x = r4.w * r4.w;
  r1.x = r4.w * r1.x;
  ...
  if (r3.x != 0) {
    ...
    r6.xyzw = t5.SampleBias(s4_s, r4.zw, cb0[61].x).xyzw;
  ...
  if (r3.y != 0) {
    ...
    r4.zw = frac(r4.zw);
    r3.xy = r4.zw + r3.xy;
    r6.xyzw = t5.SampleBias(s4_s, r3.xy, cb0[61].x).xyzw;
  ...
  r1.xy = r3.xy * cb1[25].ww + r1.xy;
  r6.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xy = v1.xy + r2.zw;
  r1.xy = r1.zz * r4.xy + r1.xy;
  r1.xy = r3.xy * cb1[26].ww + r1.xy;
  r2.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r0.zw = v1.xy + r0.zw;
  r0.zw = r1.ww * r4.xy + r0.zw;
  r0.zw = r3.xy * cb1[27].ww + r0.zw;
  r1.xyzw = t0.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  r1.xyw = cb1[26].xyz * r2.yyy;
  r1.xyw = r6.xxx * cb1[25].xyz + r1.xyw;
  r1.xyz = r1.zzz * cb1[27].xyz + r1.xyw;
  r2.xyzw = t0.SampleBias(s0_s, r0.xy, cb0[61].x).xyzw;
  r0.zw = cb1[23].xy * v1.xy;
  r0.zw = cb0[202].xy * r0.zw;
  r4.xyzw = t8.SampleBias(s1_s, r0.zw, cb0[61].x).xyzw;
