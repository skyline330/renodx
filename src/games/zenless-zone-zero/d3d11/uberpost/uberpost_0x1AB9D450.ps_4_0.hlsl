...
// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:14 2026
...
void main(
  ...
  if (r0.x != 0) {
    ...
    r4.x = cmp(0 < cb1[5].w);
    if (r4.x != 0) {
      r4.xy = cb1[5].xy * r0.ww;
      sincos(r4.x, r4.x, r5.x);
      r4.x = r4.x / r5.x;
      r4.y = 1 / r4.y;
      r4.x = r4.x * r4.y + -1;
      r2.xy = r3.xy * r4.xx + r3.zw;
    } else {
      r4.x = 1 / r0.w;
      r4.x = cb1[5].x * r4.x;
      r0.w = cb1[5].y * r0.w;
      ...
      r0.w = r0.w ? -r4.y : r4.y;
      r0.w = r4.x * r0.w + -1;
      r2.xy = r3.xy * r0.ww + r3.zw;
    }
  }
  r3.xyzw = t0.SampleBias(s0_s, r2.xy, cb0[61].x).xyzw;
  r2.xy = v1.xy + r2.zw;
  r2.xy = r1.xy * cb1[26].ww + r2.xy;
  if (r0.x != 0) {
    r2.zw = float2(-0.5, -0.5) + r2.xy;
    r3.yz = r2.zw * cb1[5].zz + float2(0.5, 0.5);
    ...
    if (r3.w != 0) {
      ...
      r0.w = r0.w ? -r4.x : r4.x;
      r0.w = r3.w * r0.w + -1;
      r2.xy = r2.zw * r0.ww + r3.yz;
    }
  }
  r2.xyzw = t0.SampleBias(s0_s, r2.xy, cb0[61].x).xyzw;
  r0.yz = v1.xy + r0.yz;
  r0.yz = r1.xy * cb1[27].ww + r0.yz;
  if (r0.x != 0) {
  ...
  r0.xyzw = t0.SampleBias(s0_s, r0.yz, cb0[61].x).xyzw;
  r0.xyw = cb1[26].xyz * r2.yyy;
  r0.xyw = r3.xxx * cb1[25].xyz + r0.xyw;
  r0.xyz = r0.zzz * cb1[27].zxy + r0.wxy;
  r2.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  ...
  if (r0.w != 0) {
    ...
    r1.x = r0.w + r0.w;
    r1.x = cmp(r1.x >= -r1.x);
    r2.xy = r1.xx ? float2(2, 0.5) : float2(-2, -0.5);
    r0.w = r2.y * r0.w;
    r0.w = frac(r0.w);
    r1.x = r2.x * r0.w;
    r2.y = cmp(1 < r1.x);
    ...
    r0.w = r2.y ? r0.w : r1.x;
    r0.w = r0.w * 2 + -1;
    r2.x = cb1[28].z * r0.w + r1.z;
    r0.w = cb0[138].x * cb0[138].w;
    r1.x = abs(cb1[29].y) + r2.x;
    r2.z = cb1[29].y * r1.w;
    r1.x = r1.x * r0.w + -r2.z;
    ...
    r2.y = cb1[29].z * r0.w + r1.w;
    r3.xyzw = t4.SampleBias(s3_s, r2.xy, cb0[61].x).xyzw;
    r2.xyz = log2(abs(r3.xyz));
    r2.xyz = float3(0.333333343, 0.333333343, 0.333333343) * r2.xyz;
    r2.xyz = exp2(r2.xyz);
    r2.xyz = r2.xyz * float3(1.49380159, 1.49380159, 1.49380159) + -r3.xyz;
    ...
    if (r1.y != 0) {
      ...
      r4.xyzw = t5.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  ...
  if (r0.w != 0) {
    ...
    r1.yz = cb1[7].zz * abs(r1.xy) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb1[6].w * r1.y;
    r0.w = dot(r1.xz, r1.xz);
    r0.w = 1 + -r0.w;
    r0.w = max(0, r0.w);
    r0.w = log2(r0.w);
    r0.w = cb1[7].w * r0.w * max(1.f, CUSTOM_VIGNETTE);
    r0.w = exp2(r0.w);
  ...
  */
  ...
  if (r0.w != 0) {
    ...
    r1.xyzw = t1.SampleBias(s1_s, r1.xy, cb0[61].x).xyzw;
    r0.w = -0.5 + r1.w;
    r0.w = r0.w + r0.w;
