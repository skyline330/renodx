...
void main(
  ...
  r0.yz = cb0[138].xy * v1.xy;
  r2.xy = (uint2)r0.yz;
  r2.zw = float2(0, 0);
  r2.xyzw = t0.Load(r2.xyz).xyzw;
  r0.yz = v1.xy * float2(2, 2) + float2(-1, -1);
  r3.xyzw = cb0[135].xyzw * -r0.zzzz;
  r3.xyzw = cb0[134].xyzw * r0.yyyy + r3.xyzw;
  r3.xyzw = cb0[136].xyzw * r2.xxxx + r3.xyzw;
  r3.xyzw = cb0[137].xyzw + r3.xyzw;
  ...
  r1.x = cb0[62].z * r2.x + cb0[62].w;
  r1.x = 1 / r1.x;
  r1.x = saturate(r1.x * cb1[34].z + -cb1[34].y);
  r1.y = -cb1[36].y + r3.w;
  r1.y = saturate(abs(r1.y) / cb1[36].x);
  r1.y = 1 + -r1.y;
  r1.y = log2(r1.y);
  r1.y = cb1[36].z * r1.y;
  r1.y = exp2(r1.y);
  r2.xyzw = cb1[34].wwww * r3.xyzw;
  ...
  r0.y = r0.w * r3.x + r0.y;
  r0.yz = r3.yw / r0.yy;
  r3.xy = cb1[35].xy * cb0[14].xx;
  r2.xy = r2.xy * cb1[35].zw + r3.xy;
  ...
  r0.yz = cb0[138].xy * r0.yz;
  r2.xy = (uint2)r0.yz;
  r2.zw = float2(0, 0);
  r2.xyzw = t0.Load(r2.xyz).xyzw;
  r0.y = cb0[62].z * r2.x + cb0[62].w;
  r0.y = 1 / r0.y;
  r0.y = saturate(r0.y * cb1[34].z + -cb1[34].y);
  r0.yz = r0.ww * r0.yy + v1.xy;
  r0.w = cmp(0 < cb1[11].w);
  if (r0.w != 0) {
    r2.xyzw = t3.SampleBias(s2_s, r0.yz, cb0[61].x).xyzw;
  ...
  r2.xy = r2.yz * r2.xx;
  r2.zw = r3.xy + r0.yz;
  r2.zw = r2.xy * cb1[25].ww + r2.zw;
  if (r0.x != 0) {
    r3.xy = float2(-0.5, -0.5) + r2.zw;
    r4.xy = r3.xy * cb1[5].zz + float2(0.5, 0.5);
    r3.xy = r3.xy * cb1[5].zz + -cb1[4].xy;
    r3.xy = cb1[4].zw * r3.xy;
    r0.w = dot(r3.xy, r3.xy);
    r0.w = sqrt(r0.w);
    r4.z = cmp(0 < cb1[5].w);
    if (r4.z != 0) {
      r4.zw = cb1[5].xy * r0.ww;
      sincos(r4.z, r5.x, r6.x);
      r4.z = r5.x / r6.x;
      r4.w = 1 / r4.w;
      r4.z = r4.z * r4.w + -1;
      r2.zw = r3.xy * r4.zz + r4.xy;
    } else {
      r4.z = 1 / r0.w;
      r4.z = cb1[5].x * r4.z;
      r0.w = cb1[5].y * r0.w;
      ...
      r0.w = r0.w ? -r4.w : r4.w;
      r0.w = r4.z * r0.w + -1;
      r2.zw = r3.xy * r0.ww + r4.xy;
    }
  }
  r4.xyzw = t1.SampleBias(s0_s, r2.zw, cb0[61].x).xyzw;
  r2.zw = r3.zw + r0.yz;
  r2.zw = r2.xy * cb1[26].ww + r2.zw;
  if (r0.x != 0) {
    r3.xy = float2(-0.5, -0.5) + r2.zw;
    r3.zw = r3.xy * cb1[5].zz + float2(0.5, 0.5);
    r3.xy = r3.xy * cb1[5].zz + -cb1[4].xy;
    r3.xy = cb1[4].zw * r3.xy;
    r0.w = dot(r3.xy, r3.xy);
    r0.w = sqrt(r0.w);
    r4.y = cmp(0 < cb1[5].w);
    if (r4.y != 0) {
      r4.yz = cb1[5].xy * r0.ww;
      sincos(r4.y, r5.x, r6.x);
      r4.y = r5.x / r6.x;
      r4.z = 1 / r4.z;
      r4.y = r4.y * r4.z + -1;
      r2.zw = r3.xy * r4.yy + r3.zw;
    } else {
      r4.y = 1 / r0.w;
      r4.y = cb1[5].x * r4.y;
      r0.w = cb1[5].y * r0.w;
      ...
      r0.w = r0.w ? -r4.z : r4.z;
      r0.w = r4.y * r0.w + -1;
      r2.zw = r3.xy * r0.ww + r3.zw;
    }
  }
  r3.xyzw = t1.SampleBias(s0_s, r2.zw, cb0[61].x).xyzw;
  r1.xy = r1.xy + r0.yz;
  r1.xy = r2.xy * cb1[27].ww + r1.xy;
  if (r0.x != 0) {
    r0.xw = float2(-0.5, -0.5) + r1.xy;
    r2.xy = r0.xw * cb1[5].zz + float2(0.5, 0.5);
    r0.xw = r0.xw * cb1[5].zz + -cb1[4].xy;
    r0.xw = cb1[4].zw * r0.xw;
    r2.z = dot(r0.xw, r0.xw);
    r2.z = sqrt(r2.z);
    r2.w = cmp(0 < cb1[5].w);
    if (r2.w != 0) {
      r3.xz = cb1[5].xy * r2.zz;
      sincos(r3.x, r3.x, r5.x);
      r2.w = r3.x / r5.x;
      r3.x = 1 / r3.z;
      r2.w = r2.w * r3.x + -1;
      r1.xy = r0.xw * r2.ww + r2.xy;
    } else {
      r2.w = 1 / r2.z;
      r2.w = cb1[5].x * r2.w;
      r2.z = cb1[5].y * r2.z;
      ...
      r2.z = r2.z ? -r3.x : r3.x;
      r2.z = r2.w * r2.z + -1;
      r1.xy = r0.xw * r2.zz + r2.xy;
    }
  }
  r2.xyzw = t1.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r2.xyw = cb1[26].xyz * r3.yyy;
  r2.xyw = r4.xxx * cb1[25].xyz + r2.xyw;
  r2.xyz = r2.zzz * cb1[27].xyz + r2.xyw;
  r3.xyzw = t1.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  ...
  if (r0.x != 0) {
    ...
    r3.y = cb1[29].z * r0.x + r1.w;
    r4.xyzw = t4.SampleBias(s3_s, r3.xy, cb0[61].x).xyzw;
    ...
    r0.x = r4.x + r4.y;
    r0.x = r0.x + r4.z;
    o0.w = saturate(r0.x * 0.333299994 + r3.w);
  } else {
    o0.w = r3.w;
  }
  ...
  if (r0.x != 0) {
    ...
    r1.yz = cb1[7].zz * abs(r0.xw) * min(1.f, CUSTOM_VIGNETTE);
    r1.x = cb1[6].w * r1.y;
