...
// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:12 2026
...
void main(
  ...
  r0.x = cmp(0 < cb1[11].w);
  if (r0.x != 0) {
    r0.xyzw = t5.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  r3.xyzw = t6.SampleBias(s3_s, r1.yz, cb0[61].x).xyzw;
  r1.y = -0.5 + r3.x;
  r1.y = r1.y + r1.y;
  ...
  r6.xyzw = t6.SampleBias(s3_s, r5.xy, cb0[61].x).xyzw;
  r5.xyzw = t6.SampleBias(s3_s, r5.zw, cb0[61].x).xyzw;
  r3.xw = float2(0.5, 0);
  r7.xyzw = t6.SampleBias(s3_s, r3.xy, cb0[61].x).yzxw;
  r1.x = r4.w * r4.w;
  r1.x = r4.w * r1.x;
  ...
  if (r3.x != 0) {
    ...
    r6.xyzw = t7.SampleBias(s4_s, r4.zw, cb0[61].x).xyzw;
  ...
  if (r3.y != 0) {
    ...
    r4.zw = frac(r4.zw);
    r3.xy = r4.zw + r3.xy;
    r6.xyzw = t7.SampleBias(s4_s, r3.xy, cb0[61].x).xyzw;
  ...
  r6.xyzw = t1.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xy = v1.xy + r2.zw;
  ...
  r4.xyzw = t10.SampleBias(s1_s, r0.zw, cb0[61].x).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r4.xyzw = t8.SampleBias(s5_s, r3.xy, cb0[61].x).xyzw;
    ...
    if (r2.y != 0) {
      ...
      r6.xyzw = t9.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  ...
  r0.xyz = renodx::lut::Sample(t3, lut_config, r1.xyz);
  ...
  */
  ...
  if (r0.w != 0) {
    ...
    r1.xyzw = t2.SampleBias(s1_s, r1.xy, cb0[61].x).xyzw;
    r0.w = -0.5 + r1.w;
    r0.w = r0.w + r0.w;
