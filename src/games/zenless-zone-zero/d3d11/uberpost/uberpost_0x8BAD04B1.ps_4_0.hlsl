...
void main(
  ...
  if (r0.z != 0) {
    ...
    if (r2.y != 0) {
      ...
      r5.xyzw = t5.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  ...
  r1.xyz = ComputeGamutCompressionScaleAndCompress(r1.xyz, gamut_compression_scale);
  ...
  r0.zxy = GamutDecompress(r0.zxy, gamut_compression_scale);
