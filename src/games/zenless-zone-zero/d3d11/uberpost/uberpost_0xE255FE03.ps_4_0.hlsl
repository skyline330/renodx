...
void main(
  ...
  if (r1.x != 0) {
    ...
    r3.xy = r3.xy * r4.zz;
    r4.zw = v1.xy + r2.xy;
    r4.zw = r1.yy * r4.xy + r4.zw;
    r4.zw = r3.xy * cb1[25].ww + r4.zw;
    r6.xyzw = t1.Sample(s0_s, r4.zw).xyzw;
    r4.zw = v1.xy + r2.zw;
    r4.zw = r1.zz * r4.xy + r4.zw;
    r4.zw = r3.xy * cb1[26].ww + r4.zw;
    r7.xyzw = t1.Sample(s0_s, r4.zw).xyzw;
    r4.zw = v1.xy + r0.zw;
    r4.zw = r1.ww * r4.xy + r4.zw;
    r3.xy = r3.xy * cb1[27].ww + r4.zw;
    r8.xyzw = t1.Sample(s0_s, r3.xy).xyzw;
    r6.yzw = cb1[26].xyz * r7.yyy;
    r6.xyz = r6.xxx * cb1[25].xyz + r6.yzw;
    r6.xyz = r8.zzz * cb1[27].xyz + r6.xyz;
    r7.xyzw = t1.Sample(s0_s, r0.xy).wxyz;
  } else {
    r2.xy = v1.xy + r2.xy;
    r1.xy = r1.yy * r4.xy + r2.xy;
    r8.xyzw = t1.Sample(s0_s, r1.xy).xyzw;
    r1.xy = v1.xy + r2.zw;
    r1.xy = r1.zz * r4.xy + r1.xy;
    r2.xyzw = t1.Sample(s0_s, r1.xy).xyzw;
    r0.zw = v1.xy + r0.zw;
    r0.zw = r1.ww * r4.xy + r0.zw;
    r6.xyzw = t1.Sample(s0_s, r0.zw).xyzw;
    r7.xyzw = t1.Sample(s0_s, r0.xy).wxyz;
    r6.x = r8.x;
    r6.y = r2.y;
  }
  ...
  r1.xyzw = t10.Sample(s1_s, r0.zw).xyzw;
  r1.xyz = float3(12, 12, 12) * r1.xyz;
  r0.z = 25 * cb0[14].x;
  r0.z = frac(r0.z);
  r0.w = 1 + -v1.y;
  r0.z = r0.z + -r0.w;
  ...
  r0.z = 1 + -cb1[23].z;
  r1.xyz = r1.xyz * r0.zzz + cb1[23].zzz;
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r0.xyz = UberpostArriLutSample(r1.xyz, t3, s0_s);
  } else {
