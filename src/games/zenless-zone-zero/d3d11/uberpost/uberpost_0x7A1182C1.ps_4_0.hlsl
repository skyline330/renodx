...
// ---- Created with 3Dmigoto v1.4.1 on Wed Jun 17 01:21:24 2026
...
void main(
  ...
  r8.xyzw = t7.Sample(s3_s, r6.xy).xyzw;
  r6.xyzw = t7.Sample(s3_s, r6.zw).xyzw;
  r7.xw = float2(0.5, 0);
  r9.xyzw = t7.Sample(s3_s, r7.xy).yzxw;
  r1.z = r5.y * r5.y;
  r1.z = r5.y * r1.z;
  ...
  if (r1.z != 0) {
    ...
    r6.xyzw = t8.Sample(s4_s, r4.zw).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r4.zw = frac(r4.zw);
    r1.zw = r4.zw + r1.zw;
    r6.xyzw = t8.Sample(s4_s, r1.zw).xyzw;
  ...
  if (r1.z != 0) {
    ...
    r8.xyzw = t2.Sample(s0_s, r4.zw).xyzw;
    r4.zw = r0.xy + r0.zw;
    r4.zw = r3.ww * r4.xy + r4.zw;
    r1.zw = r1.zw * cb1[27].ww + r4.zw;
    r9.xyzw = t2.Sample(s0_s, r1.zw).xyzw;
    r6.yzw = cb1[26].xyz * r8.yyy;
    r6.xyz = r6.xxx * cb1[25].xyz + r6.yzw;
    r6.xyz = r9.zzz * cb1[27].xyz + r6.xyz;
    r8.xyzw = t2.Sample(s0_s, r1.xy).wxyz;
  } else {
    r1.zw = r2.xy + r0.xy;
  ...
  if (r0.z != 0) {
    ...
    r3.xyzw = t9.Sample(s5_s, r3.xy).xyzw;
    ...
    r4.xyz = r8.xxx * r4.xyz + r3.xyz;
    r4.xyz = r0.www ? r4.xyz : r3.xyz;
    if (r1.w != 0) {
      r0.zw = r1.xy * cb1[20].xy + cb1[20].zw;
      r5.xyzw = t10.Sample(s0_s, r0.zw).xyzw;
    ...
    r0.z = r4.x + r4.y;
    r0.z = r0.z + r4.z;
    o0.w = saturate(r0.z * 0.333299994 + r8.x);
  } else {
    o0.w = r8.x;
  }
