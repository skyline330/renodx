...
// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:13 2026
...
void main(
  ...
  if (r0.y != 0) {
    ...
    if (r0.x != 0) {
      ...
      r3.xy = r1.xy * cb1[5].zz + float2(0.5, 0.5);
    ...
    if (r0.x != 0) {
      ...
      r3.y = cmp(0 < cb1[5].w);
      if (r3.y != 0) {
        r3.yz = cb1[5].xy * r0.ww;
        sincos(r3.y, r4.x, r5.x);
        r3.y = r4.x / r5.x;
        r3.z = 1 / r3.z;
        r3.y = r3.y * r3.z + -1;
        r2.zw = r1.xy * r3.yy + r2.xy;
      } else {
        r3.y = 1 / r0.w;
        r3.y = cb1[5].x * r3.y;
        r0.w = cb1[5].y * r0.w;
        ...
        r0.w = r0.w ? -r3.z : r3.z;
        r0.w = r3.y * r0.w + -1;
        r2.zw = r1.xy * r0.ww + r2.xy;
      }
    }
    r2.xyzw = t0.SampleBias(s0_s, r2.zw, cb0[61].x).xyzw;
    r0.yz = v1.xy + r0.yz;
    if (r0.x != 0) {
    ...
    r0.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  }
