...
void main(
  ...
  r0.z = cmp(0 < cb1[11].w);
  if (r0.z != 0) {
    r1.xyzw = t3.SampleBias(s2_s, r0.xy, cb0[61].x).xyzw;
  ...
  r3.xyzw = t4.SampleBias(s3_s, r3.xy, cb0[61].x).xyzw;
  r1.w = -0.5 + r3.x;
  r1.w = r1.w + r1.w;
  ...
  r8.xyzw = t4.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
  r6.xyzw = t4.SampleBias(s3_s, r6.zw, cb0[61].x).xyzw;
  r7.x = 0.5;
  r7.xyzw = t4.SampleBias(s3_s, r7.xy, cb0[61].x).yzxw;
  r1.z = r5.y * r5.y;
  r1.z = r5.y * r1.z;
  ...
  if (r1.w != 0) {
    ...
    r4.zw = frac(r4.zw);
    r1.zw = r4.zw + r1.zw;
    r6.xyzw = t5.SampleBias(s4_s, r1.zw, cb0[61].x).xyzw;
