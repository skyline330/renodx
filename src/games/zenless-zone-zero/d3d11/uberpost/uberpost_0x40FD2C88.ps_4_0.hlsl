...
void main(
  ...
  if (r2.z != 0) {
    ...
    if (r1.w != 0) {
      ...
      r2.xy = v1.xy + r2.xy;
      r6.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
      r6.x = r8.x;
      r6.y = r5.y;
    } else {
  ...
  if (r1.w != 0) {
    ...
    if (r2.y != 0) {
      ...
      r8.xyzw = t4.Sample(s0_s, r7.yz).xyzw;
  ...
  r2.zw = r2.zw + r1.yz;
  r0.w = (uint)cb2[13].x;
  r5.xyzw = t8.Sample(s7_s, r2.zw).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r5.xyzw = t7.Sample(s6_s, r0.xy).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r5.xyzw, icb[r0.x + 0].xyzw);
  r2.xyzw = t5.Sample(s4_s, r2.zw).xyzw;
