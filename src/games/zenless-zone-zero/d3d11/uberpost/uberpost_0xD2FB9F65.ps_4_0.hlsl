...
// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:23 2026
...
void main(
  ...
  if (r1.w != 0) {
    ...
    r5.xyzw = t1.SampleBias(s0_s, r5.zw, cb0[61].x).xyzw;
    r2.xy = v1.xy + r2.xy;
    ...
    r3.xy = v1.xy;
    r2.xyzw = t1.SampleBias(s0_s, v1.xy, cb0[61].x).xyzw;
  }
  ...
  r2.xyz = renodx::lut::Sample(t2, lut_config, r2.xyz);
