...
void main(
  ...
  if (r1.x != 0) {
    ...
    r7.xyzw = t0.Sample(s0_s, r4.zw).xyzw;
    r4.zw = v1.xy + r0.zw;
    ...
    r7.xyzw = t0.Sample(s0_s, r0.xy).wxyz;
  } else {
    r2.xy = v1.xy + r2.xy;
    r1.xy = r1.yy * r4.xy + r2.xy;
    r8.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
    r1.xy = v1.xy + r2.zw;
  ...
  r1.xyzw = t8.Sample(s1_s, r0.zw).xyzw;
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r0.zxy = UberpostSrgbLutSample(r1.xyz, cb1[0], t2, s0_s);
  } else {
