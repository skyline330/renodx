...
void main(
  ...
  if (r1.y != 0) {
    ...
    r3.xyzw = t9.SampleBias(s8_s, r2.yz, cb0[61].x).xyzw;
  ...
  r1.y = cmp(0 < cb1[11].w);
  if (r1.y != 0) {
    r3.xyzw = t2.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  if (r0.x != 0) {
    ...
    r7.xyzw = t3.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
    ...
    if (r4.y != 0) {
      ...
      r8.xyzw = t4.SampleBias(s0_s, r4.xy, cb0[61].x).xyzw;
  ...
  if (r0.x != 0) {
    ...
    r6.yz = cb1[7].zz * abs(r1.yz) * min(1.f, CUSTOM_VIGNETTE);
    r6.x = cb1[6].w * r6.y;
  ...
  if (r0.x != 0) {
    ...
    r6.xyzw = t1.SampleBias(s1_s, r1.yz, cb0[61].x).xyzw;
    r0.x = -0.5 + r6.w;
    r0.x = r0.x + r0.x;
  ...
  r1.yz = r1.yz + r2.yz;
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t8.SampleBias(s7_s, r1.yz, cb0[61].x).xyzw;
  ...
  r0.xy = r0.xy + r2.yz;
  r0.z = (uint)cb2[10].y;
  r2.xyzw = t7.SampleBias(s6_s, r0.xy, cb0[61].x).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r2.xyzw, icb[r0.x + 0].xyzw);
  r2.xyzw = t5.SampleBias(s4_s, r1.yz, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r2.xyzw = t6.SampleBias(s5_s, r4.zw, cb0[61].x).xyzw;
