...
void main(
  ...
  if (r1.x != 0) {
    ...
    if (r0.y != 0) {
      ...
      r3.xyzw = t0.Sample(s0_s, r0.yz).zxyw;
      r3.y = r5.x;
      r3.z = r2.y;
    } else {
      r3.xyzw = t0.Sample(s0_s, r1.zw).zxyw;
    }
    r4.xyzw = t0.Sample(s0_s, r1.zw).wxyz;
  }
  ...
  if (r0.x != 0) {
    ...
    r1.x = dot(r3.yzx, float3(0.298999995, 0.587000012, 0.114));
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r0.zxy = UberpostSrgbLutSample(r3.xyz, cb1[0], t2, s0_s);
  } else {
