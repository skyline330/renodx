...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t12.Sample(s8_s, r1.yz).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r5.xyzw = t6.Sample(s3_s, r5.xy).xyzw;
    ...
    if (r2.y != 0) {
      ...
      r8.xyzw = t7.Sample(s0_s, r7.yz).xyzw;
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r2.xyz = UberpostArriLutSample(r6.xyz, t3, s0_s);
  } else {
    r2.xyz = r6.zxy * float3(5.55555582, 5.55555582, 5.55555582) + float3(0.0479959995, 0.0479959995, 0.0479959995);
    r2.xyz = log2(r2.xyz);
  ...
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t11.Sample(s7_s, r5.xy).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r3.xyzw = t10.Sample(s6_s, r0.xy).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r3.xyzw, icb[r0.x + 0].xyzw);
  r3.xyzw = t8.Sample(s4_s, r5.xy).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t9.Sample(s5_s, r5.zw).xyzw;
