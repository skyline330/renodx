...
void main(
  ...
  r0.x = cmp(0 < cb1[11].w);
  if (r0.x != 0) {
    r0.xyzw = t2.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  r3.xyzw = t3.SampleBias(s3_s, r1.yz, cb0[61].x).xyzw;
  r1.y = -0.5 + r3.x;
  r1.y = r1.y + r1.y;
  ...
  r6.xyzw = t3.SampleBias(s3_s, r5.xy, cb0[61].x).xyzw;
  r5.xyzw = t3.SampleBias(s3_s, r5.zw, cb0[61].x).xyzw;
  r3.x = 0.5;
  r3.xyzw = t3.SampleBias(s3_s, r3.xy, cb0[61].x).yzxw;
  r1.x = r4.w * r4.w;
  r1.x = r4.w * r1.x;
  ...
  if (r4.z != 0) {
    ...
    r5.xyzw = t4.SampleBias(s4_s, r5.xy, cb0[61].x).xyzw;
  ...
  if (r4.w != 0) {
    ...
    r5.xy = frac(r5.xy);
    r4.zw = r5.xy + r4.zw;
    r5.xyzw = t4.SampleBias(s4_s, r4.zw, cb0[61].x).xyzw;
  ...
  r5.xyzw = t0.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r1.xy = v1.xy + r2.zw;
  ...
  r4.xyzw = t7.SampleBias(s1_s, r0.zw, cb0[61].x).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r3.xyzw = t5.SampleBias(s5_s, r3.xy, cb0[61].x).xyzw;
    ...
    if (r2.y != 0) {
      ...
      r5.xyzw = t6.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  ...
  if (r0.x != 0) {
    ...
    r0.xyzw = t1.SampleBias(s1_s, r0.xy, cb0[61].x).xyzw;
    r0.x = -0.5 + r0.w;
    r0.x = r0.x + r0.x;
