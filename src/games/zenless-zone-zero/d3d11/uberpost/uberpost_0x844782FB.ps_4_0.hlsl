...
void main(
  ...
  if (r1.w != 0) {
    ...
    r2.xyzw = t10.SampleBias(s8_s, r2.xy, cb0[61].x).xyzw;
  ...
  r1.w = cmp(0 < cb1[11].w);
  if (r1.w != 0) {
    r5.xyzw = t3.SampleBias(s2_s, r0.xy, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    if (r2.w != 0) {
      ...
      r8.xyzw = t5.SampleBias(s0_s, r2.zw, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r6.xyzw = t2.SampleBias(s1_s, r2.zw, cb0[61].x).xyzw;
    r1.w = -0.5 + r6.w;
    r1.w = r1.w + r1.w;
  ...
  r2.zw = r2.zw + r2.xy;
  r0.w = (uint)cb2[13].x;
  r7.xyzw = t9.SampleBias(s7_s, r2.zw, cb0[61].x).xyzw;
  ...
  r2.xyzw = t6.SampleBias(s4_s, r2.zw, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r2.xyzw = t7.SampleBias(s5_s, r6.xy, cb0[61].x).xyzw;
