...
// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:22 2026
...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t10.SampleBias(s8_s, r1.yz, cb0[61].x).xyzw;
  ...
  r1.w = cmp(0 < cb1[11].w);
  if (r1.w != 0) {
    r2.xyzw = t3.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  r6.xyzw = t0.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
  r5.xy = v1.xy + r5.zw;
  r5.xy = r2.zw * cb1[26].ww + r5.xy;
  r5.xyzw = t0.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
  r2.xy = v1.xy + r2.xy;
  r2.xy = r2.zw * cb1[27].ww + r2.xy;
  r2.xyzw = t0.SampleBias(s0_s, r2.xy, cb0[61].x).xyzw;
  r2.xyw = cb1[26].xyz * r5.yyy;
  r2.xyw = r6.xxx * cb1[25].xyz + r2.xyw;
  r2.xyz = r2.zzz * cb1[27].zxy + r2.wxy;
  r5.xyzw = t0.SampleBias(s0_s, r3.xy, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r6.xyzw = t4.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
    ...
    r1.w = dot(r2.yzx, float3(0.298999995, 0.587000012, 0.114));
    ...
    if (r5.y != 0) {
      ...
      r8.xyzw = t5.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
      r5.xyz = cb1[21].yyy * r8.xyz;
      r7.xyz = r5.xyz * r6.xyz + r7.xyz;
    }
    r2.xyz = r7.zxy + r2.xyz;
    r1.w = r7.x + r7.y;
    r1.w = r1.w + r7.z;
  ...
  */
  ...
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t9.SampleBias(s7_s, r5.xy, cb0[61].x).xyzw;
  ...
  r3.xyzw = t6.SampleBias(s4_s, r5.xy, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t7.SampleBias(s5_s, r5.zw, cb0[61].x).xyzw;
