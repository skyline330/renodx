...
void main(
  ...
  if (r1.y != 0) {
    ...
    r3.xyzw = t10.SampleBias(s8_s, r2.yz, cb0[61].x).xyzw;
  ...
  r1.y = cmp(0 < cb1[11].w);
  if (r1.y != 0) {
    r3.xyzw = t3.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  r7.xy = float2(-0.333333343, -0.333333343) * r3.zw;
  r7.z = 9.99999975e-05;
  ...
  r3.zw = r3.zw * r2.ww;
  r4.xy = v1.xy + r6.xy;
  r4.xy = r3.zw * cb1[25].ww + r4.xy;
  if (r0.x != 0) {
    r6.xy = float2(-0.5, -0.5) + r4.xy;
    r7.xy = r6.xy * cb1[5].zz + float2(0.5, 0.5);
    ...
    if (r2.w != 0) {
      ...
      sincos(r7.z, r5.x, r8.x);
      r2.w = r5.x / r8.x;
      r5.x = 1 / r7.w;
      r2.w = r2.w * r5.x + -1;
      r4.xy = r6.xy * r2.ww + r7.xy;
    } else {
      r2.w = 1 / r1.y;
      r2.w = cb1[5].x * r2.w;
      r1.y = cb1[5].y * r1.y;
      ...
      r1.y = r1.y ? -r5.x : r5.x;
      r1.y = r2.w * r1.y + -1;
      r4.xy = r6.xy * r1.yy + r7.xy;
    }
  }
  r7.xyzw = t0.SampleBias(s0_s, r4.xy, cb0[61].x).xyzw;
  r4.xy = v1.xy + r6.zw;
  r4.xy = r3.zw * cb1[26].ww + r4.xy;
  if (r0.x != 0) {
    r6.xy = float2(-0.5, -0.5) + r4.xy;
    ...
    r2.w = cmp(0 < cb1[5].w);
    if (r2.w != 0) {
      r7.yz = cb1[5].xy * r1.yy;
      sincos(r7.y, r5.x, r8.x);
      r2.w = r5.x / r8.x;
      r5.x = 1 / r7.z;
      r2.w = r2.w * r5.x + -1;
  ...
  r6.xyzw = t0.SampleBias(s0_s, r4.xy, cb0[61].x).xyzw;
  r3.xy = v1.xy + r3.xy;
  r3.xy = r3.zw * cb1[27].ww + r3.xy;
  if (r0.x != 0) {
  ...
  r3.xyzw = t0.SampleBias(s0_s, r3.xy, cb0[61].x).xyzw;
  r3.xyw = cb1[26].xyz * r6.yyy;
  r3.xyw = r7.xxx * cb1[25].xyz + r3.xyw;
  r3.xyz = r3.zzz * cb1[27].zxy + r3.wxy;
  r6.xyzw = t0.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  ...
  if (r0.x != 0) {
    ...
    r0.x = r2.w ? r0.x : r1.y;
    r0.x = r0.x * 2 + -1;
    r6.x = cb1[28].z * r0.x + r1.z;
    r0.x = cb0[138].x * cb0[138].w;
    r1.y = abs(cb1[29].y) + r6.x;
    r2.w = cb1[29].y * r1.w;
    r1.y = r1.y * r0.x + -r2.w;
    r0.x = dot(cb1[29].xx, r0.xx);
    r0.x = r1.y / r0.x;
    r0.x = frac(r0.x);
    r0.x = cmp(0.5 >= r0.x);
    r0.x = r0.x ? 0.999989986 : -1;
    r6.y = cb1[29].z * r0.x + r1.w;
    r7.xyzw = t4.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
    ...
    r0.x = dot(r3.yzx, float3(0.298999995, 0.587000012, 0.114));
    ...
    if (r4.y != 0) {
      ...
      r8.xyzw = t5.SampleBias(s0_s, r4.xy, cb0[61].x).xyzw;
      r8.xyz = cb1[21].yyy * r8.xyz;
      r7.xyz = r8.xyz * r6.xyz + r7.xyz;
    }
    r3.xyz = r7.zxy + r3.xyz;
    r0.x = r7.x + r7.y;
    r0.x = r0.x + r7.z;
  ...
  float3 hdr_color = r3.xyz;
  float3 hdr_color_tm = renodx::tonemap::neutwo::ComputeBT709Scale(hdr_color);
  if (RENODX_TONE_MAP_TYPE > 0) {
    r3.xyz = (hdr_color * hdr_color_tm);
  }

  float4 lutParams = cb1[0];

  bool useSDRLut = (lutParams.w > 0.0f);

  renodx::lut::Config lut_config = renodx::lut::config::Create(
      s0_s,
      useSDRLut ? lutParams.w * RENODX_COLOR_GRADE_LUT_STRENGTH : 0,
      RENODX_COLOR_GRADE_LUT_SCALING,
      renodx::lut::config::type::SRGB,
      renodx::lut::config::type::SRGB);

  r1.yzw = renodx::lut::Sample(
      t2,
      lut_config,
      r1.xyz);
  ...
  r1.yzw = float3(12.9200001, 12.9200001, 12.9200001) * r3.xyz;
  r6.xyz = log2(r3.xyz);
  ...
  r3.xyz = cmp(float3(0.00313080009, 0.00313080009, 0.00313080009) >= r3.xyz);
  r1.yzw = r3.xyz ? r1.yzw : r6.xyz;
  r3.xyz = cb1[0].zzz * r1.yzw;
  r0.x = floor(r3.x);
  r1.zw = float2(0.5, 0.5) * cb1[0].xy;
  r3.yz = r3.yz * cb1[0].xy + r1.zw;
  r3.x = r0.x * cb1[0].y + r3.y;
  r6.xyzw = t2.SampleLevel(s0_s, r3.xz, 0).xyzw;
  r4.z = cb1[0].y;
  r1.zw = r3.xz + r4.zw;
  r3.xyzw = t2.SampleLevel(s0_s, r1.zw, 0).xyzw;
  r0.x = r1.y * cb1[0].z + -r0.x;
  r1.yzw = r3.xyz + -r6.xyz;
  r1.yzw = r0.xxx * r1.yzw + r6.xyz;
  r3.xyz = float3(0.0773993805, 0.0773993805, 0.0773993805) * r1.yzw;
  r4.xyz = float3(0.0549999997, 0.0549999997, 0.0549999997) + r1.yzw;
  ...
  r1.yzw = r1.yzw ? r3.xyz : r4.xyz;
  */

  r0.x = cmp(0 < cb1[13].x);
  if (r0.x != 0) {
    r3.xy = v1.xy * cb1[8].xy + cb1[8].zw;
    r3.xyzw = t1.SampleBias(s1_s, r3.xy, cb0[61].x).xyzw;
    r0.x = -0.5 + r3.w;
    r0.x = r0.x + r0.x;
    r2.w = dot(r1.yzw, float3(0.212672904, 0.715152204, 0.0721750036));
    r2.w = sqrt(r2.w);
    r2.w = cb1[13].y * -r2.w + 1;
    r3.xyz = r1.yzw * r0.xxx;
    r3.xyz = cb1[13].xxx * r3.xyz;
    r1.yzw = r3.xyz * r2.www + r1.yzw;
  }
  r3.y = cb2[0].y * r2.x + 1;
  r3.xw = float2(1, 1);
  r0.xz = r3.xy * r0.zw;
  r0.w = min(abs(r0.z), abs(r0.x));
  r2.x = max(abs(r0.z), abs(r0.x));
  r2.x = 1 / r2.x;
  r0.w = r2.x * r0.w;
  r2.x = r0.w * r0.w;
  ...
  r0.x = sqrt(r0.x);
  r3.xy = float2(1.27323949, 0.5) * r0.wx;
  r0.xz = r0.yy * cb2[10].zw + cb3[0].xy;
  r2.xw = r0.yy * cb2[11].xy + cb3[0].zw;
  r4.xy = float2(-0.5, -0.5) + v1.xy;
  r3.z = cb0[138].x * cb0[138].w;
  r3.zw = r4.xy * r3.zw + float2(0.5, 0.5);
  x0[0].xy = r3.zw;
  x0[1].xy = r3.xy;
  x0[2].xy = v1.xy;
  r0.w = round(cb2[6].z);
  ...
  r0.w = min(2, (int)r0.w);
  r4.xy = x0[r0.w + 0].xy;
  r4.xy = r4.xy * cb2[7].xy + cb2[7].zw;
  r4.xy = r0.yy * cb2[8].xy + r4.xy;
  r4.xy = r4.xy + r2.yz;
  x1[0].xy = r3.zw;
  x1[1].xy = r3.xy;
  x1[2].xy = v1.xy;
  ...
  r2.xw = r2.xw + r2.yz;
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t9.SampleBias(s7_s, r2.xw, cb0[61].x).xyzw;
  r0.w = min(3, (uint)r0.w);
  r0.w = dot(r6.xyzw, icb[r0.w + 0].xyzw);
  r0.w = -0.498039216 + r0.w;
  r0.w = r0.w + r0.w;
  r2.x = cmp(cb2[3].x < 9.99999975e-06);
  ...
  r2.xw = r4.zw * r2.xx + cb2[2].zw;
  r2.xw = r0.yy * cb2[6].xy + r2.xw;
  r2.xw = r0.ww * cb2[13].yy + r2.xw;
  r2.xw = r2.xw + r2.yz;
  x3[0].xy = r3.zw;
  x3[1].xy = r3.xy;
  x3[2].xy = v1.xy;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r2.xyzw = t7.SampleBias(s5_s, r4.xy, cb0[61].x).xyzw;
  ...
  r0.x = r0.x * r0.y;
  r0.yzw = r3.xyz + -r1.yzw;
  r0.yzw = r0.xxx * r0.yzw + r1.yzw;
  r2.xyz = r3.xyz * r0.xxx + r1.yzw;
  ...
  r6.xyz = cmp(r1.yzw < float3(0.5, 0.5, 0.5));
  r7.xyz = r3.xyz * r1.yzw;
