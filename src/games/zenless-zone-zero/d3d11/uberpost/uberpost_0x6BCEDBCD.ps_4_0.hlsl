...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t15.SampleBias(s10_s, r1.yz, cb0[61].x).xyzw;
  ...
  r1.w = cmp(0 < cb1[11].w);
  if (r1.w != 0) {
    r2.xyzw = t5.SampleBias(s2_s, v1.xy, cb0[61].x).xyzw;
  ...
  r1.w = frac(cb0[14].x);
  r2.zw = v1.xy * float2(5, 5) + r1.ww;
  r6.xyzw = t6.SampleBias(s3_s, r2.zw, cb0[61].x).xyzw;
  r2.z = -0.5 + r6.x;
  r2.z = r2.z + r2.z;
  r2.w = cmp(abs(r2.z) >= cb1[15].z);
  r2.w = r2.w ? 1.000000 : 0;
  r2.z = r2.z * r2.w;
  r2.z = cb1[15].y * r2.z;
  r2.z = 0.00999999978 * r2.z;
  sincos(cb1[14].w, r4.x, r6.x);
  r7.xyz = cb1[14].xyz * float3(0.100000001, 0.100000001, 0.100000001) + r2.zzz;
  r6.y = r4.x;
  r2.zw = r7.xy * r6.yy;
  r4.x = r7.z * r6.y;
  r6.zw = float2(88, 1234) * r1.ww;
  r6.zw = frac(r6.zw);
  r1.w = v1.y + r6.z;
  r8.yw = r1.ww * cb1[15].xx + r2.zw;
  r3.w = r1.w * cb1[15].x + r4.x;
  r8.xz = float2(0.5, 0.5);
  r9.xyzw = t6.SampleBias(s3_s, r8.xy, cb0[61].x).xyzw;
  r8.xyzw = t6.SampleBias(s3_s, r8.zw, cb0[61].x).xyzw;
  r10.xyzw = t6.SampleBias(s3_s, r3.zw, cb0[61].x).yzxw;
  r1.w = r6.w * r6.w;
  r1.w = r6.w * r1.w;
  r2.z = max(cb1[16].y, cb1[16].x);
  r2.z = -cb1[16].x + r2.z;
  r1.w = r1.w * r2.z + cb1[16].x;
  r10.x = r9.x;
  r10.y = r8.x;
  r8.xyz = cmp(r1.www >= r10.xyz);
  r8.xyz = r8.xyz ? float3(1, 1, 1) : 0;
  r8.xyz = cb1[16].zzz * r8.xyz;
  r2.zw = cmp(float2(0.5, 0.5) < cb1[19].zw);
  if (r2.z != 0) {
    r3.zw = v1.xy * cb1[17].xy + cb1[17].zw;
    r9.xyzw = t7.SampleBias(s4_s, r3.zw, cb0[61].x).xyzw;
    r8.xyz = r9.xxx * r8.xyz;
  }
  if (r2.w != 0) {
    r2.zw = v1.xy * cb1[18].xy + cb1[18].zw;
    r3.zw = cb1[19].xy * cb0[14].xx;
    r3.zw = frac(r3.zw);
    r2.zw = r3.zw + r2.zw;
    r9.xyzw = t7.SampleBias(s4_s, r2.zw, cb0[61].x).xyzw;
  ...
  r9.xy = float2(-0.333333343, -0.333333343) * r2.zw;
  r9.z = 9.99999975e-05;
  ...
  r2.zw = r2.zw * r3.zz;
  r3.zw = v1.xy + r5.xy;
  r3.zw = r7.xx * r6.xy + r3.zw;
  r3.zw = r2.zw * cb1[25].ww + r3.zw;
  r9.xyzw = t1.SampleBias(s0_s, r3.zw, cb0[61].x).xyzw;
  r3.zw = v1.xy + r5.zw;
  r3.zw = r7.yy * r6.xy + r3.zw;
  r3.zw = r2.zw * cb1[26].ww + r3.zw;
  r5.xyzw = t1.SampleBias(s0_s, r3.zw, cb0[61].x).xyzw;
  r2.xy = v1.xy + r2.xy;
  r2.xy = r7.zz * r6.xy + r2.xy;
  r2.xy = r2.zw * cb1[27].ww + r2.xy;
  r2.xyzw = t1.SampleBias(s0_s, r2.xy, cb0[61].x).xyzw;
  r2.xyw = cb1[26].xyz * r5.yyy;
  r2.xyw = r9.xxx * cb1[25].xyz + r2.xyw;
  r2.xyz = r2.zzz * cb1[27].xyz + r2.xyw;
  r5.xyzw = t1.SampleBias(s0_s, r3.xy, cb0[61].x).xyzw;
  r3.zw = cb1[23].xy * v1.xy;
  r3.zw = cb0[202].xy * r3.zw;
  r6.xyzw = t10.SampleBias(s1_s, r3.zw, cb0[61].x).xyzw;
  r5.xyz = float3(12, 12, 12) * r6.xyz;
  r1.w = 25 * cb0[14].x;
  r1.w = frac(r1.w);
  r2.w = 1 + -v1.y;
  r1.w = -r2.w + r1.w;
  ...
  r1.w = 1 + -cb1[23].z;
  r5.xyz = r5.xyz * r1.www + cb1[23].zzz;
  r2.xyz = r2.xyz * r5.xyz + r8.xyz;
  r1.w = cmp(cb1[21].z < 0.5);
  r3.zw = cmp(float2(0, 0) < cb1[21].xy);
  ...
  if (r1.w != 0) {
    ...
    r2.w = r1.w + r1.w;
    r2.w = cmp(r2.w >= -r2.w);
    r5.xy = r2.ww ? float2(2, 0.5) : float2(-2, -0.5);
    r1.w = r5.y * r1.w;
    r1.w = frac(r1.w);
    r2.w = r5.x * r1.w;
    r3.z = cmp(1 < r2.w);
    ...
    r1.w = r3.z ? r1.w : r2.w;
    r1.w = r1.w * 2 + -1;
    r5.x = cb1[28].z * r1.w + r3.x;
    r1.w = cb0[138].x * cb0[138].w;
    r2.w = abs(cb1[29].y) + r5.x;
    r3.z = cb1[29].y * r3.y;
    r2.w = r2.w * r1.w + -r3.z;
    ...
    r5.y = cb1[29].z * r1.w + r3.y;
    r6.xyzw = t8.SampleBias(s5_s, r5.xy, cb0[61].x).xyzw;
    ...
    r7.xyz = cmp(r6.xyz >= float3(0.300000012, 0.300000012, 0.300000012));
    ...
    r6.xyz = r2.www ? r6.xyz : r5.xyz;
    if (r3.w != 0) {
      r3.zw = r3.xy * cb1[20].xy + cb1[20].zw;
      r7.xyzw = t9.SampleBias(s0_s, r3.zw, cb0[61].x).xyzw;
      r7.xyz = cb1[21].yyy * r7.xyz;
  ...
  if (r1.w != 0) {
    ...
    r3.yz = cb1[7].zz * abs(r3.xy) * min(1.f, CUSTOM_VIGNETTE);
    r3.x = cb1[6].w * r3.y;
    ...
    r1.w = exp2(r1.w);
    r3.xyz = float3(1, 1, 1) + -cb1[6].xyz;
    r3.xyz = r1.www * r3.xyz + cb1[6].xyz;
  ...
  r2.xyz = renodx::lut::Sample(t3, lut_config, r2.xyz);
  ...
  r3.yz = r2.zw * cb1[0].xy + r3.xy;
  r3.x = r1.w * cb1[0].y + r3.y;
  r5.xyzw = t3.SampleLevel(s0_s, r3.xz, 0).xyzw;
  r6.x = cb1[0].y;
  r6.yz = float2(0, 1);
  r2.yz = r6.xy + r3.xz;
  r3.xyzw = t3.SampleLevel(s0_s, r2.yz, 0).xyzw;
...
*/
  ...
  if (r1.w != 0) {
    ...
    r3.xyzw = t2.SampleBias(s1_s, r3.xy, cb0[61].x).xyzw;
    r1.w = -0.5 + r3.w;
    r1.w = r1.w + r1.w;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r6.xyzw = t13.SampleBias(s8_s, r0.xy, cb0[61].x).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r6.xyzw, icb[r0.x + 0].xyzw);
  r3.xyzw = t11.SampleBias(s6_s, r3.zw, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t12.SampleBias(s7_s, r5.zw, cb0[61].x).xyzw;
  ...
  r0.xyz = cb4[1].www * r1.xyz + r0.xyz;
  r0.w = saturate(dot(r0.xyz, float3(0.212672904, 0.715152204, 0.0721750036)));
  r0.w = -cb4[2].y + r0.w;
  r0.w = saturate(cb4[2].z * r0.w);
  r1.xyz = cb4[1].xyz + -cb4[0].xyz;
  r1.xyz = r0.www * r1.xyz + cb4[0].xyz;
  r1.xyz = r1.xyz + -r0.xyz;

  // r0.xyz = saturate(cb4[2].xxx * r1.xyz + r0.xyz);
  r0.xyz = (cb4[2].xxx * r1.xyz + r0.xyz);

  // HDR FX Mask Blend
  float3 result = r0.xyz;
  r0.w = cmp(0.5 < cb4[2].w);
  if (r0.w != 0) {
    r1.xyzw = t4.SampleBias(s0_s, v1.xy, cb0[61].x).xyzw;
    float m = smoothstep(0.0f, 1.0f, r1.x);
    r0.w = cmp(cb4[3].w < 0.5);
    if (r0.w != 0) {
  ...
  if (r0.w != 0) {
    ...
    r2.xyz = cb4[3].xyz * r0.xyz;
    r2.xyz = r2.xyz + r2.xyz;
    r3.xyz = float3(1, 1, 1) + -r0.xyz;
    r3.xyz = r3.xyz + r3.xyz;
    r4.xyz = float3(1, 1, 1) + -cb4[3].xyz;
