...
void main(
  ...
  r3.x = 0.5;
  r3.xyzw = t5.Sample(s3_s, r3.xy).yzxw;
  r1.x = r4.w * r4.w;
  r1.x = r4.w * r1.x;
  ...
  if (r4.z != 0) {
    ...
    r5.xyzw = t6.Sample(s4_s, r5.xy).xyzw;
  ...
  if (r4.w != 0) {
    ...
    r5.xy = frac(r5.xy);
    r4.zw = r5.xy + r4.zw;
    r5.xyzw = t6.Sample(s4_s, r4.zw).xyzw;
  ...
  if (r1.x != 0) {
    ...
    r4.zw = r4.zw * r3.ww;
    r5.xy = v1.xy + r2.xy;
    r5.xy = r1.yy * r4.xy + r5.xy;
    r5.xy = r4.zw * cb1[25].ww + r5.xy;
    r5.xyzw = t1.Sample(s0_s, r5.xy).xyzw;
    r5.yz = v1.xy + r2.zw;
    r5.yz = r1.zz * r4.xy + r5.yz;
    r5.yz = r4.zw * cb1[26].ww + r5.yz;
    r6.xyzw = t1.Sample(s0_s, r5.yz).xyzw;
    r5.yz = v1.xy + r0.zw;
    r5.yz = r1.ww * r4.xy + r5.yz;
    r4.zw = r4.zw * cb1[27].ww + r5.yz;
    r7.xyzw = t1.Sample(s0_s, r4.zw).xyzw;
    r5.yzw = cb1[26].xyz * r6.yyy;
    r5.xyz = r5.xxx * cb1[25].xyz + r5.yzw;
    r5.xyz = r7.zzz * cb1[27].xyz + r5.xyz;
    r6.xyzw = t1.Sample(s0_s, r0.xy).wxyz;
  } else {
    r2.xy = v1.xy + r2.xy;
    r1.xy = r1.yy * r4.xy + r2.xy;
    r7.xyzw = t1.Sample(s0_s, r1.xy).xyzw;
    r1.xy = v1.xy + r2.zw;
  ...
  r1.xyzw = t9.Sample(s1_s, r0.zw).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r3.xyz = r6.xxx * r3.xyz + r2.xzw;
    r3.xyz = r0.www ? r3.xyz : r2.xzw;
    if (r2.y != 0) {
      r0.zw = r0.xy * cb1[20].xy + cb1[20].zw;
      r4.xyzw = t8.Sample(s0_s, r0.zw).xyzw;
    ...
    r0.z = r3.x + r3.y;
    r0.z = r0.z + r3.z;
    o0.w = saturate(r0.z * 0.333299994 + r6.x);
  } else {
    o0.w = r6.x;
  }
