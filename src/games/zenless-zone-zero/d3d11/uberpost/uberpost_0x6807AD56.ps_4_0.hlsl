...
void main(
  ...
  r0.w = cmp(0 < cb1[11].w);
  if (r0.w != 0) {
    r2.xyzw = t4.SampleBias(s2_s, r0.yz, cb0[61].x).xyzw;
  ...
  if (r0.x != 0) {
    ...
    r4.xyzw = t5.SampleBias(s3_s, r3.xy, cb0[61].x).xyzw;
    ...
    if (r1.y != 0) {
      ...
      r5.xyzw = t6.SampleBias(s0_s, r0.xw, cb0[61].x).xyzw;
  ...
  r1.xyz = renodx::lut::Sample(t3, lut_config, r2.xyz);
