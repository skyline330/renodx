...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t12.SampleBias(s8_s, r1.yz, cb0[61].x).xyzw;
  ...
  r2.zw = r2.zw * r4.xx;
  r5.xy = v1.xy + r5.xy;
  r5.xy = r2.zw * cb1[25].ww + r5.xy;
  r6.xyzw = t1.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
  r5.xy = v1.xy + r5.zw;
  r5.xy = r2.zw * cb1[26].ww + r5.xy;
  r5.xyzw = t1.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
  r2.xy = v1.xy + r2.xy;
  r2.xy = r2.zw * cb1[27].ww + r2.xy;
  r2.xyzw = t1.SampleBias(s0_s, r2.xy, cb0[61].x).xyzw;
  r2.xyw = cb1[26].xyz * r5.yyy;
  r2.xyw = r6.xxx * cb1[25].xyz + r2.xyw;
  ...
  if (r1.w != 0) {
    ...
    r6.xyzw = t6.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
    ...
    if (r5.y != 0) {
      ...
      r8.xyzw = t7.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r5.yz = cb1[7].zz * abs(r3.xy) * min(1.f, CUSTOM_VIGNETTE);
    r5.x = cb1[6].w * r5.y;
  ...
  */
  ...
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t11.SampleBias(s7_s, r5.xy, cb0[61].x).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r3.xyzw = t10.SampleBias(s6_s, r0.xy, cb0[61].x).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r3.xyzw, icb[r0.x + 0].xyzw);
  r3.xyzw = t8.SampleBias(s4_s, r5.xy, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t9.SampleBias(s5_s, r5.zw, cb0[61].x).xyzw;
