...
void main(
  ...
  if (r1.w != 0) {
    ...
    r2.xyzw = t11.SampleBias(s8_s, r2.xy, cb0[61].x).xyzw;
  ...
  r1.w = cmp(0 < cb1[11].w);
  if (r1.w != 0) {
    r5.xyzw = t4.SampleBias(s2_s, r0.xy, cb0[61].x).xyzw;
  ...
  r7.xyzw = t1.SampleBias(s0_s, r5.zw, cb0[61].x).xyzw;
  r5.zw = r6.zw + r0.xy;
  r5.zw = r5.xy * cb1[26].ww + r5.zw;
  r6.xyzw = t1.SampleBias(s0_s, r5.zw, cb0[61].x).xyzw;
  r2.zw = r2.zw + r0.xy;
  r2.zw = r5.xy * cb1[27].ww + r2.zw;
  r5.xyzw = t1.SampleBias(s0_s, r2.zw, cb0[61].x).xyzw;
  r5.xyw = cb1[26].xyz * r6.yyy;
  r5.xyw = r7.xxx * cb1[25].xyz + r5.xyw;
  r5.xyz = r5.zzz * cb1[27].xyz + r5.xyw;
  r6.xyzw = t1.SampleBias(s0_s, r3.xy, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r7.xyzw = t5.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
    ...
    r7.xyz = r2.zzz ? r7.xyz : r6.xyz;
    if (r2.w != 0) {
      r2.zw = r3.xy * cb1[20].xy + cb1[20].zw;
      r8.xyzw = t6.SampleBias(s0_s, r2.zw, cb0[61].x).xyzw;
  ...
  r3.xyz = renodx::lut::Sample(t3, lut_config, r5.xyz);
  ...
  */
  ...
  if (r1.w != 0) {
    ...
    r5.xyzw = t2.SampleBias(s1_s, r2.zw, cb0[61].x).xyzw;
    r1.w = -0.5 + r5.w;
    r1.w = r1.w + r1.w;
  ...
  r2.zw = r2.zw + r2.xy;
  r0.w = (uint)cb2[13].x;
  r7.xyzw = t10.SampleBias(s7_s, r2.zw, cb0[61].x).xyzw;
  ...
  r0.xy = r0.xy + r2.xy;
  r0.z = (uint)cb2[10].y;
  r5.xyzw = t9.SampleBias(s6_s, r0.xy, cb0[61].x).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r5.xyzw, icb[r0.x + 0].xyzw);
  r2.xyzw = t7.SampleBias(s4_s, r2.zw, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r2.xyzw = t8.SampleBias(s5_s, r6.xy, cb0[61].x).xyzw;
