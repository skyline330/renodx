...
// ---- Created with 3Dmigoto v1.4.1 on Wed Jun 17 01:21:32 2026
...
void main(
  ...
  if (r2.w != 0) {
    ...
    if (r0.x != 0) {
      ...
      r5.x = cmp(0 < cb1[5].w);
      if (r5.x != 0) {
        r8.xy = cb1[5].xy * r2.ww;
        sincos(r8.x, r5.x, r8.x);
        r5.x = r5.x / r8.x;
        r8.x = 1 / r8.y;
        r5.x = r5.x * r8.x + -1;
        r4.xy = r7.xy * r5.xx + r7.zw;
      } else {
        r5.x = 1 / r2.w;
        r5.x = cb1[5].x * r5.x;
        r2.w = cb1[5].y * r2.w;
    ...
    if (r0.x != 0) {
      r7.yz = float2(-0.5, -0.5) + r4.xy;
      r8.xy = r7.yz * cb1[5].zz + float2(0.5, 0.5);
      r7.yz = r7.yz * cb1[5].zz + -cb1[4].xy;
      r7.yz = cb1[4].zw * r7.yz;
      r2.w = dot(r7.yz, r7.yz);
      r2.w = sqrt(r2.w);
      r5.x = cmp(0 < cb1[5].w);
      if (r5.x != 0) {
        r8.zw = cb1[5].xy * r2.ww;
        sincos(r8.z, r5.x, r9.x);
        r5.x = r5.x / r9.x;
        r7.w = 1 / r8.w;
        r5.x = r5.x * r7.w + -1;
        r4.xy = r7.yz * r5.xx + r8.xy;
      } else {
        r5.x = 1 / r2.w;
        r5.x = cb1[5].x * r5.x;
        r2.w = cb1[5].y * r2.w;
        ...
        r2.w = r2.w ? -r7.w : r7.w;
        r2.w = r5.x * r2.w + -1;
        r4.xy = r7.yz * r2.ww + r8.xy;
      }
    }
    r8.xyzw = t0.Sample(s0_s, r4.xy).xyzw;
    r4.xy = v1.xy + r3.xy;
    r3.zw = r3.zw * cb1[27].ww + r4.xy;
    if (r0.x != 0) {
      r4.xy = float2(-0.5, -0.5) + r3.zw;
      r7.yz = r4.xy * cb1[5].zz + float2(0.5, 0.5);
      ...
      r5.x = cmp(0 < cb1[5].w);
      if (r5.x != 0) {
        r8.xz = cb1[5].xy * r2.ww;
        sincos(r8.x, r5.x, r8.x);
        r5.x = r5.x / r8.x;
        r7.w = 1 / r8.z;
        r5.x = r5.x * r7.w + -1;
        r3.zw = r4.xy * r5.xx + r7.yz;
      } else {
        r5.x = 1 / r2.w;
        r5.x = cb1[5].x * r5.x;
        r2.w = cb1[5].y * r2.w;
        ...
        r2.w = r2.w ? -r7.w : r7.w;
        r2.w = r5.x * r2.w + -1;
        r3.zw = r4.xy * r2.ww + r7.yz;
      }
    }
    r9.xyzw = t0.Sample(s0_s, r3.zw).xyzw;
    r7.yzw = cb1[26].xyz * r8.yyy;
    r7.xyz = r7.xxx * cb1[25].xyz + r7.yzw;
    r7.xyz = r9.zzz * cb1[27].xyz + r7.xyz;
    r8.xyzw = t0.Sample(s0_s, r1.zw).wxyz;
  } else {
    if (r1.y != 0) {
      r3.zw = v1.xy + r6.xy;
      if (r0.x != 0) {
        r4.xy = float2(-0.5, -0.5) + r3.zw;
        r6.xy = r4.xy * cb1[5].zz + float2(0.5, 0.5);
        r4.xy = r4.xy * cb1[5].zz + -cb1[4].xy;
        r4.xy = cb1[4].zw * r4.xy;
        ...
        r2.w = cmp(0 < cb1[5].w);
        if (r2.w != 0) {
          r9.xy = cb1[5].xy * r1.yy;
          sincos(r9.x, r5.x, r9.x);
          r2.w = r5.x / r9.x;
          r5.x = 1 / r9.y;
          r2.w = r2.w * r5.x + -1;
          r3.zw = r4.xy * r2.ww + r6.xy;
        } else {
          r2.w = 1 / r1.y;
          r2.w = cb1[5].x * r2.w;
          r1.y = cb1[5].y * r1.y;
      ...
      if (r0.x != 0) {
        ...
        r2.w = cmp(0 < cb1[5].w);
        if (r2.w != 0) {
          r6.zw = cb1[5].xy * r1.yy;
          sincos(r6.z, r5.x, r10.x);
          r2.w = r5.x / r10.x;
          r5.x = 1 / r6.w;
          r2.w = r2.w * r5.x + -1;
          r3.zw = r4.xy * r2.ww + r6.xy;
  ...
  if (r0.x != 0) {
    ...
    r1.y = r0.x + r0.x;
    r1.y = cmp(r1.y >= -r1.y);
    r3.xz = r1.yy ? float2(2, 0.5) : float2(-2, -0.5);
    r0.x = r3.z * r0.x;
    r0.x = frac(r0.x);
    r1.y = r3.x * r0.x;
    r2.w = cmp(1 < r1.y);
    ...
    r0.x = r2.w ? r0.x : r1.y;
    r0.x = r0.x * 2 + -1;
    r4.x = cb1[28].z * r0.x + r1.z;
    r0.x = cb0[138].x * cb0[138].w;
    r1.y = abs(cb1[29].y) + r4.x;
    r2.w = cb1[29].y * r1.w;
    r1.y = r1.y * r0.x + -r2.w;
    ...
    r4.y = cb1[29].z * r0.x + r1.w;
    r6.xyzw = t3.Sample(s3_s, r4.xy).xyzw;
    r3.xzw = log2(abs(r6.xyz));
    r3.xzw = float3(0.333333343, 0.333333343, 0.333333343) * r3.xzw;
    r3.xzw = exp2(r3.xzw);
    r3.xzw = r3.xzw * float3(1.49380159, 1.49380159, 1.49380159) + -r6.xyz;
    r8.yzw = cmp(r6.xyz >= float3(0.300000012, 0.300000012, 0.300000012));
    r8.yzw = r8.yzw ? float3(1, 1, 1) : 0;
    r3.xzw = float3(-0.699999988, -0.699999988, -0.699999988) + r3.xzw;
    r3.xzw = r8.yzw * r3.xzw + r6.xyz;
    r3.xzw = cb1[21].xxx * r3.xzw;
    r0.x = dot(r7.xyz, float3(0.298999995, 0.587000012, 0.114));
    r1.y = cmp(0.5 < cb1[22].x);
    r6.xyz = r0.xxx * r3.xzw + -r3.xzw;
    r6.xyz = r8.xxx * r6.xyz + r3.xzw;
    r6.xyz = r1.yyy ? r6.xyz : r3.xzw;
    if (r3.y != 0) {
      r4.xy = r1.zw * cb1[20].xy + cb1[20].zw;
      r9.xyzw = t4.Sample(s0_s, r4.xy).xyzw;
      r8.yzw = cb1[21].yyy * r9.xyz;
      r6.xyz = r8.yzw * r3.xzw + r6.xyz;
    }
    r7.xyz = r7.xyz + r6.xyz;
    r0.x = r6.x + r6.y;
    r0.x = r0.x + r6.z;
    o0.w = saturate(r0.x * 0.333299994 + r8.x);
  } else {
    o0.w = r8.x;
  }
  ...
  if (r0.x != 0) {
    ...
    r3.yz = cb1[7].zz * abs(r1.yz) * min(1.f, CUSTOM_VIGNETTE);
    r3.x = cb1[6].w * r3.y;
  ...
  r4.x = cb0[138].x * cb0[138].w;
  r4.y = 1;
  r2.xw = r2.xw * r4.xy + float2(0.5, 0.5);
  x0[0].xy = r2.xw;
  x0[1].xy = r3.xy;
  x0[2].xy = v1.xy;
  r0.w = round(cb2[6].z);
  ...
  r0.w = min(2, (int)r0.w);
  r4.xy = x1[r0.w + 0].xy;
  r4.xy = r4.xy * cb2[12].xy + cb2[12].zw;
  r1.yz = r4.xy + r1.yz;
  r1.yz = r1.yz + r2.yz;
  r0.w = (uint)cb2[13].x;
  r4.xyzw = t8.Sample(s7_s, r1.yz).xyzw;
  r0.w = min(3, (uint)r0.w);
  r0.w = dot(r4.xyzw, icb[r0.w + 0].xyzw);
  r0.w = -0.498039216 + r0.w;
  r0.w = r0.w + r0.w;
  r1.y = cmp(cb2[3].x < 9.99999975e-06);
  r1.z = 0.00092592591 * cb0[138].y;
  r1.z = max(1, r1.z);
  r1.y = r1.y ? r1.z : 1;
  x2[0].xy = r2.xw;
  x2[1].xy = r3.xy;
