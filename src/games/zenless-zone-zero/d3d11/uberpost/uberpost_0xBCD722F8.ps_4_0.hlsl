...
void main(
  ...
  r0.z = cmp(0 < cb1[11].w);
  if (r0.z != 0) {
    r1.xyzw = t6.SampleBias(s2_s, r0.xy, cb0[61].x).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r4.xyzw = t7.SampleBias(s3_s, r3.xy, cb0[61].x).xyzw;
  ...
  r1.xyz = renodx::lut::Sample(t4, lut_config, r2.xyz);
  ...
  */
  ...
  if (r0.w != 0) {
    r1.xyzw = t5.SampleBias(s0_s, v1.xy, cb0[61].x).xyzw;
