...
// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:16 2026
...
void main(
  ...
  r4.xyzw = t0.SampleBias(s0_s, r0.xy, cb0[61].x).xyzw;
  r0.zw = cb1[23].xy * v1.xy;
  r0.zw = cb0[202].xy * r0.zw;
  r7.xyzw = t8.SampleBias(s1_s, r0.zw, cb0[61].x).xyzw;
  ...
  if (r0.z != 0) {
    ...
    r5.xyzw = t6.SampleBias(s5_s, r3.xy, cb0[61].x).xyzw;
