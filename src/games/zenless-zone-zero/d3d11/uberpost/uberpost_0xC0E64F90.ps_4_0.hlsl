...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t11.Sample(s8_s, r1.yz).xyzw;
  ...
  if (r2.z != 0) {
    ...
    r2.zw = r2.zw * r6.xx;
    r6.xy = v1.xy + r5.xy;
    r6.xy = r2.zw * cb1[25].ww + r6.xy;
    r6.xyzw = t1.Sample(s0_s, r6.xy).xyzw;
    r6.yz = v1.xy + r5.zw;
    r6.yz = r2.zw * cb1[26].ww + r6.yz;
    r7.xyzw = t1.Sample(s0_s, r6.yz).xyzw;
    r6.yz = v1.xy + r2.xy;
    r2.zw = r2.zw * cb1[27].ww + r6.yz;
    r8.xyzw = t1.Sample(s0_s, r2.zw).xyzw;
    ...
    if (r1.w != 0) {
      ...
      r2.xy = v1.xy + r2.xy;
      r6.xyzw = t1.Sample(s0_s, r2.xy).xyzw;
      r6.x = r8.x;
      r6.y = r5.y;
    } else {
      r6.xyzw = t1.Sample(s0_s, r3.xy).xyzw;
    }
    r7.xyzw = t1.Sample(s0_s, r3.xy).wxyz;
  }
  ...
  if (r1.w != 0) {
    ...
    r2.x = r1.w + r1.w;
    r2.x = cmp(r2.x >= -r2.x);
    r2.xz = r2.xx ? float2(2, 0.5) : float2(-2, -0.5);
    r1.w = r2.z * r1.w;
    r1.w = frac(r1.w);
    r2.z = r2.x * r1.w;
    r2.w = cmp(1 < r2.z);
    ...
    r5.xyzw = t5.Sample(s3_s, r5.xy).xyzw;
    ...
    r7.yzw = cmp(r5.xyz >= float3(0.300000012, 0.300000012, 0.300000012));
    r7.yzw = r7.yzw ? float3(1, 1, 1) : 0;
    r2.xzw = float3(-0.699999988, -0.699999988, -0.699999988) + r2.xzw;
    r2.xzw = r7.yzw * r2.xzw + r5.xyz;
    r2.xzw = cb1[21].xxx * r2.xzw;
    r1.w = dot(r6.xyz, float3(0.298999995, 0.587000012, 0.114));
    r4.x = cmp(0.5 < cb1[22].x);
    r5.xyz = r1.www * r2.xzw + -r2.xzw;
    r5.xyz = r7.xxx * r5.xyz + r2.xzw;
    r5.xyz = r4.xxx ? r5.xyz : r2.xzw;
    if (r2.y != 0) {
      r7.yz = r3.xy * cb1[20].xy + cb1[20].zw;
      r8.xyzw = t6.Sample(s0_s, r7.yz).xyzw;
      r7.yzw = cb1[21].yyy * r8.xyz;
      r5.xyz = r7.yzw * r2.xzw + r5.xyz;
    }
  ...
  r1.w = cmp(0 < cb1[7].z);
  if (r1.w != 0) {
    r2.xy = -cb1[7].xy + r3.xy;
    r2.yz = cb1[7].zz * abs(r2.xy) * min(1.f, CUSTOM_VIGNETTE);
    r2.x = cb1[6].w * r2.y;
    ...
    r1.w = exp2(r1.w);
    r2.xyz = float3(1, 1, 1) + -cb1[6].xyz;
    r2.xyz = r1.www * r2.xyz + cb1[6].xyz;
  ...
  if (r1.w != 0) {
    ...
    r2.x = sqrt(r2.x);
    r2.x = cb1[13].y * -r2.x + 1;
    r2.yzw = r6.xyz * r1.www;
    r2.yzw = cb1[13].xxx * r2.yzw;
    r6.xyz = r2.yzw * r2.xxx + r6.xyz;
  }
  r3.w = cb2[0].y * r0.w + 1;
  r0.yz = r3.zw * r0.yz;
  ...
  r0.y = sqrt(r0.y);
  r2.xy = float2(1.27323949, 0.5) * r0.wy;
  r0.yz = r0.xx * cb2[10].zw + cb3[0].xy;
  r2.zw = r0.xx * cb2[11].xy + cb3[0].zw;
  r3.xy = float2(-0.5, -0.5) + v1.xy;
  r5.x = cb0[138].x * cb0[138].w;
  r5.y = 1;
  r3.xy = r3.xy * r5.xy + float2(0.5, 0.5);
  x0[0].xy = r3.xy;
  x0[1].xy = r2.xy;
  x0[2].xy = v1.xy;
  r0.w = round(cb2[6].z);
  ...
  r2.zw = r2.zw + r1.yz;
  r0.w = (uint)cb2[13].x;
  r5.xyzw = t10.Sample(s7_s, r2.zw).xyzw;
  ...
  r7.xyz = r1.zzz * r5.xyz + cb2[4].xyz;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r2.xyzw = t8.Sample(s5_s, r3.zw).xyzw;
  ...
  r0.x = r0.x * r0.y;
  r0.yzw = r1.yzw + -r6.xyz;
  r0.yzw = r0.xxx * r0.yzw + r6.xyz;
  r2.xyz = r1.yzw * r0.xxx + r6.xyz;
  ...
  r5.xyz = cmp(r6.xyz < float3(0.5, 0.5, 0.5));
