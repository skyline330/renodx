...
void main(
  ...
  if (r1.y != 0) {
    ...
    r2.xyzw = t9.SampleBias(s8_s, r1.yz, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r6.xyzw = t3.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
    ...
    if (r5.y != 0) {
      ...
      r8.xyzw = t4.SampleBias(s0_s, r5.xy, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r5.xyzw = t1.SampleBias(s1_s, r3.xy, cb0[61].x).xyzw;
    r1.w = -0.5 + r5.w;
    r1.w = r1.w + r1.w;
  ...
  r3.zw = r3.zw + r1.yz;
  r0.w = (uint)cb2[13].x;
  r6.xyzw = t8.SampleBias(s7_s, r3.zw, cb0[61].x).xyzw;
  ...
  r0.xy = r0.xy + r1.yz;
  r0.z = (uint)cb2[10].y;
  r6.xyzw = t7.SampleBias(s6_s, r0.xy, cb0[61].x).xyzw;
  r0.x = min(3, (uint)r0.z);
  r0.x = dot(r6.xyzw, icb[r0.x + 0].xyzw);
  r3.xyzw = t5.SampleBias(s4_s, r3.zw, cb0[61].x).xyzw;
  ...
  r0.x = r0.w ? r0.x : r0.z;
  r0.z = (uint)cb2[6].w;
  r3.xyzw = t6.SampleBias(s5_s, r5.zw, cb0[61].x).xyzw;
