...
void main(
  ...
  r0.z = cmp(0 < cb1[11].w);
  if (r0.z != 0) {
    r1.xyzw = t4.SampleBias(s2_s, r0.xy, cb0[61].x).xyzw;
  ...
  r3.xyzw = t5.SampleBias(s3_s, r3.xy, cb0[61].x).xyzw;
  r1.w = -0.5 + r3.x;
  r1.w = r1.w + r1.w;
  ...
  r8.xyzw = t5.SampleBias(s3_s, r6.xy, cb0[61].x).xyzw;
  r6.xyzw = t5.SampleBias(s3_s, r6.zw, cb0[61].x).xyzw;
  r7.xw = float2(0.5, 0);
  r9.xyzw = t5.SampleBias(s3_s, r7.xy, cb0[61].x).yzxw;
  r1.z = r5.y * r5.y;
  r1.z = r5.y * r1.z;
  ...
  if (r1.z != 0) {
    ...
    r6.xyzw = t6.SampleBias(s4_s, r4.zw, cb0[61].x).xyzw;
  ...
  if (r1.w != 0) {
    ...
    r4.zw = frac(r4.zw);
    r1.zw = r4.zw + r1.zw;
    r6.xyzw = t6.SampleBias(s4_s, r1.zw, cb0[61].x).xyzw;
  ...
  r6.xyzw = t1.SampleBias(s0_s, r2.xy, cb0[61].x).xyzw;
  r2.xy = r2.zw + r0.xy;
  ...
  r3.xyzw = t1.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  r2.xyz = cb1[26].xyz * r2.yyy;
  r2.xyz = r6.xxx * cb1[25].xyz + r2.xyz;
  r2.xyz = r3.zzz * cb1[27].xyz + r2.xyz;
  r3.xyzw = t1.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r0.zw = cb1[23].xy * r0.xy;
  r0.zw = cb0[202].xy * r0.zw;
  r4.xyzw = t9.SampleBias(s1_s, r0.zw, cb0[61].x).xyzw;
  r3.xyz = float3(12, 12, 12) * r4.xyz;
  r0.z = 25 * cb0[14].x;
  r0.z = frac(r0.z);
  r0.w = 1 + -r0.y;
  r0.z = r0.z + -r0.w;
  ...
  r0.z = 1 + -cb1[23].z;
  r3.xyz = r3.xyz * r0.zzz + cb1[23].zzz;
  ...
  if (r0.z != 0) {
    ...
    r4.xyzw = t7.SampleBias(s5_s, r3.xy, cb0[61].x).xyzw;
