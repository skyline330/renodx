...
void main(
  ...
  if (r2.z != 0) {
    ...
    r6.xyz = r8.zzz * cb1[27].zxy + r6.zxy;
    ...
    if (r1.w != 0) {
      ...
      r2.xy = v1.xy + r2.xy;
      r6.xyzw = t0.Sample(s0_s, r2.xy).zxyw;
      r6.y = r8.x;
      r6.z = r5.y;
    } else {
      r6.xyzw = t0.Sample(s0_s, r3.xy).zxyw;
    }
    r7.xyzw = t0.Sample(s0_s, r3.xy).wxyz;
  }
  ...
  if (r1.w != 0) {
    ...
    r5.xyzw = t4.Sample(s3_s, r5.xy).xyzw;
    ...
    r1.w = dot(r6.yzx, float3(0.298999995, 0.587000012, 0.114));
    ...
    if (r2.y != 0) {
      ...
      r8.xyzw = t5.Sample(s0_s, r7.yz).xyzw;
      r7.yzw = cb1[21].yyy * r8.xyz;
      r5.xyz = r7.yzw * r2.xzw + r5.xyz;
    }
    r6.xyz = r6.xyz + r5.zxy;
    r1.w = r5.x + r5.y;
    r1.w = r1.w + r5.z;
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    r2.zxy = UberpostSrgbLutSample(r6.xyz, cb1[0], t2, s0_s);
  } else {
    r6.xyz = saturate(r6.xyz);
    r2.xyz = float3(12.9200001, 12.9200001, 12.9200001) * r6.xyz;
    r5.xyz = log2(r6.xyz);
    ...
    r6.xyz = cmp(float3(0.00313080009, 0.00313080009, 0.00313080009) >= r6.xyz);
