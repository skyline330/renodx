...
// Version 2.7 - General Lutbuilder

// ---- Created with 3Dmigoto v1.4.1 on Thu Mar 26 19:56:17 2026
...
void main(
  ...
  if (RENODX_TONE_MAP_TYPE != 0) {
    o0.xyz = applyUserToneMap(untonemapped, cb0[166], t1, s2_s);
    o0.w = 1.0f;
    return;
  }

  r0.w = cmp(0 < cb0[166].w);
  if (r0.w != 0) {
    ...
    r2.xyz = cb0[166].zzz * r1.zxy;
    r0.w = floor(r2.x);
    r2.xw = float2(0.5, 0.5) * cb0[166].xy;
    r2.yz = r2.yz * cb0[166].xy + r2.xw;
    r2.x = r0.w * cb0[166].y + r2.y;
    r3.xyzw = t1.SampleLevel(s2_s, r2.xz, 0).xyzw;
    r4.x = cb0[166].y;
    r4.y = 0;
    r2.xy = r4.xy + r2.xz;
    r2.xyzw = t1.SampleLevel(s2_s, r2.xy, 0).xyzw;
    r0.w = r1.z * cb0[166].z + -r0.w;
    r2.xyz = r2.xyz + -r3.xyz;
    r2.xyz = r0.www * r2.xyz + r3.xyz;
    r2.xyz = r2.xyz + -r1.xyz;
    r1.xyz = cb0[166].www * r2.xyz + r1.xyz;
  ...
  o0.xyz = saturate(r0.xyz * cb0[191].zzz + r1.xxx);
  o0.w = 1;
  return;
}
