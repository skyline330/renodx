...
// Version 2.7 - Character Lutbuilder

// ---- Created with 3Dmigoto v1.4.1 on Tue Mar 24 17:20:03 2026
...
void main(
  ...
  r0.yz = -cb0[169].yz + v1.xy;
  r1.x = cb0[169].x * r0.y;
  r0.x = frac(r1.x);
  r1.x = r0.x / cb0[169].x;
  r0.w = -r1.x + r0.y;
  r0.xyz = r0.xzw * cb0[169].www + float3(-0.386036009, -0.386036009, -0.386036009);
  ...
  r0.xyz = r0.xyz * cb0[175].zzz + float3(0.0275523961, 0.0275523961, 0.0275523961);
  r0.xyz = float3(13.6054821, 13.6054821, 13.6054821) * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r0.xyz = float3(-0.0479959995, -0.0479959995, -0.0479959995) + r0.xyz;
  r0.xyz = cb0[171].xyz * r0.xyz;
  r0.xyz = float3(0.179999992, 0.179999992, 0.179999992) * r0.xyz;
  ...
  r0.w = saturate(cb0[183].w + r0.w);
  r1.x = 1 + -r0.w;
  r1.yzw = float3(-0.5, -0.5, -0.5) + cb0[183].xyz;
  r1.xyz = r1.xxx * r1.yzw + float3(0.5, 0.5, 0.5);
  r2.xyz = float3(-0.5, -0.5, -0.5) + cb0[184].xyz;
  ...
  r0.xyz = exp2(r0.xyz);
  r1.x = dot(r0.xyz, cb0[172].xyz);
  r1.y = dot(r0.xyz, cb0[173].xyz);
  r1.z = dot(r0.xyz, cb0[174].xyz);
  r0.x = dot(r1.xyz, float3(0.212672904, 0.715152204, 0.0721750036));
  r0.yz = cb0[182].yw + -cb0[182].xz;
  r0.xw = -cb0[182].xz + r0.xx;
  ...
  r1.yzw = cb0[168].zzz * r1.xyz;
  r0.w = floor(r1.y);
  r2.xy = float2(0.5, 0.5) * cb0[168].xy;
  r2.yz = r1.zw * cb0[168].xy + r2.xy;
  r2.x = r0.w * cb0[168].y + r2.y;
  r3.xyzw = t0.SampleLevel(s1_s, r2.xz, 0).xyzw;
  r4.x = cb0[168].y;
  r4.y = 0;
  r1.yz = r4.xy + r2.xz;
  r2.xyzw = t0.SampleLevel(s1_s, r1.yz, 0).xyzw;
  r0.w = r1.x * cb0[168].z + -r0.w;
  ...
  r0.xyz = cb0[168].www * r1.xyz + r0.xyz;
  r0.w = max(r0.x, r0.y);
  r0.w = max(r0.w, r0.z);
  r0.w = 1 + r0.w;
  r0.w = 1 / r0.w;
  ...
  renodx::lut::Config lut_config = renodx::lut::config::Create(
      s2_s,
      cb0[166].w * injectedData.colorGradeLUTStrength,
      injectedData.colorGradeLUTScaling,
      renodx::lut::config::type::SRGB,
      renodx::lut::config::type::SRGB,
      cb0[166].xyz  // precompute
  );

  r1.xyz = cb0[185].xxx * r0.xyz;
  r2.xyzw = cmp(r1.xxyy < cb0[185].yzyz);
  r3.xyzw = r2.yyyy ? cb0[188].xyzw : cb0[190].xyzw;
  r4.xyzw = r2.yyww ? cb0[189].xyxy : cb0[191].xyxy;
  r3.xyzw = r2.xxxx ? cb0[186].xyzw : r3.xyzw;
  r4.xyzw = r2.xxzz ? cb0[187].xyxy : r4.xyzw;
  r0.x = r0.x * cb0[185].x + -r3.x;
  r0.x = r0.x * r3.z;
  r0.w = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.y * r0.x;
  ...
  r0.x = r0.w ? r0.x : 0;
  r3.x = r0.x * r3.w + r3.y;
  r5.xyzw = r2.wwww ? cb0[188].xyzw : cb0[190].xyzw;
  r2.xyzw = r2.zzzz ? cb0[186].xyzw : r5.xyzw;
  r0.x = r0.y * cb0[185].x + -r2.x;
  r0.x = r0.x * r2.z;
  r0.y = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.w * r0.x;
  ...
  r0.x = r0.y ? r0.x : 0;
  r3.y = r0.x * r2.w + r2.y;
  r0.xy = cmp(r1.zz < cb0[185].yz);
  r1.xyzw = r0.yyyy ? cb0[188].xyzw : cb0[190].xyzw;
  r0.yw = r0.yy ? cb0[189].xy : cb0[191].xy;
  r1.xyzw = r0.xxxx ? cb0[186].xyzw : r1.xyzw;
  r0.xy = r0.xx ? cb0[187].xy : r0.yw;
  r0.z = r0.z * cb0[185].x + -r1.x;
  r0.z = r0.z * r1.z;
  r0.w = cmp(0 < r0.z);
  r0.z = log2(r0.z);
  r0.y = r0.y * r0.z;
  ...
  if (r0.x != 0) {
    ...
    r1.xyz = cb0[166].zzz * r0.zxy;
    r0.w = floor(r1.x);
    r1.xw = float2(0.5,0.5) * cb0[166].xy;
    r1.yz = r1.yz * cb0[166].xy + r1.xw;
    r1.x = r0.w * cb0[166].y + r1.y;
    r2.xyzw = t1.SampleLevel(s2_s, r1.xz, 0).xyzw;
    r4.x = cb0[166].y;
    r4.y = 0;
    r1.xy = r4.xy + r1.xz;
    r1.xyzw = t1.SampleLevel(s2_s, r1.xy, 0).xyzw;
    r0.w = r0.z * cb0[166].z + -r0.w;
    r1.xyz = r1.xyz + -r2.xyz;
    r1.xyz = r0.www * r1.xyz + r2.xyz;
    r1.xyz = r1.xyz + -r0.xyz;
    r0.xyz = cb0[166].www * r1.xyz + r0.xyz;
  ...
  o0.xyz = saturate(r0.xzw * cb0[191].zzz + r0.yyy);
  o0.w = 1;
  return;
}
