...
// Version 3.0 - General lutbuilder
...
void main(
  ...
  if (r0.w != 0) {
    ...
    r2.xyz = cb0[171].zzz * r1.zxy;
    r0.w = floor(r2.x);
    r2.xw = float2(0.5, 0.5) * cb0[171].xy;
    r2.yz = r2.yz * cb0[171].xy + r2.xw;
    r2.x = r0.w * cb0[171].y + r2.y;
    r3.xyzw = t1.SampleLevel(s2_s, r2.xz, 0).xyzw;
    r4.x = cb0[171].y;
    r4.y = 0;
    r2.xy = r4.xy + r2.xz;
    r2.xyzw = t1.SampleLevel(s2_s, r2.xy, 0).xyzw;
    r0.w = r1.z * cb0[171].z + -r0.w;
    r2.xyz = r2.xyz + -r3.xyz;
    r2.xyz = r0.www * r2.xyz + r3.xyz;
    r2.xyz = r2.xyz + -r1.xyz;
    r1.xyz = cb0[171].www * r2.xyz + r1.xyz;
  ...
  // o0.xyz = saturate(r0.xyz * cb0[196].zzz + r1.xxx);
  o0.xyz = (r0.xyz * cb0[196].zzz + r1.xxx);
  o0.w = 1;
  return;
}
