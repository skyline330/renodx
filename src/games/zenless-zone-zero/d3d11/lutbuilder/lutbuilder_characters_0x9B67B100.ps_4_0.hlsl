...
// Version 2.8 - Character Lutbuilder
...
void main(
  ...
  r0.yz = -cb0[170].yz + v1.xy;
  r1.x = cb0[170].x * r0.y;
  r0.x = frac(r1.x);
  r1.x = r0.x / cb0[170].x;
  r0.w = -r1.x + r0.y;
  r0.xyz = r0.xzw * cb0[170].www + float3(-0.386036009, -0.386036009, -0.386036009);
  ...
  r0.xyz = r0.xyz * cb0[176].zzz + float3(0.0275523961, 0.0275523961, 0.0275523961);
  r0.xyz = float3(13.6054821, 13.6054821, 13.6054821) * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r0.xyz = float3(-0.0479959995, -0.0479959995, -0.0479959995) + r0.xyz;
  r0.xyz = cb0[172].xyz * r0.xyz;
  r0.xyz = float3(0.179999992, 0.179999992, 0.179999992) * r0.xyz;
  ...
  r0.w = saturate(cb0[184].w + r0.w);
  r1.x = 1 + -r0.w;
  r1.yzw = float3(-0.5, -0.5, -0.5) + cb0[184].xyz;
  r1.xyz = r1.xxx * r1.yzw + float3(0.5, 0.5, 0.5);
  r2.xyz = float3(-0.5, -0.5, -0.5) + cb0[185].xyz;
  ...
  r0.xyz = exp2(r0.xyz);
  r1.x = dot(r0.xyz, cb0[173].xyz);
  r1.y = dot(r0.xyz, cb0[174].xyz);
  r1.z = dot(r0.xyz, cb0[175].xyz);
  r0.x = dot(r1.xyz, float3(0.212672904, 0.715152204, 0.0721750036));
  r0.yz = cb0[183].yw + -cb0[183].xz;
  r0.xw = -cb0[183].xz + r0.xx;
  ...
  r3.z = r1.x / r0.y;
  r3.yw = float2(0, 0);
  r1.xyzw = t7.SampleBias(s0_s, r3.xy, cb0[61].x).xyzw;
  r1.x = saturate(r1.x);
  r0.y = r1.x + r1.x;
  r1.xyzw = t8.SampleBias(s0_s, r3.zw, cb0[61].x).xyzw;
  r1.x = saturate(r1.x);
  r0.y = dot(r1.xx, r0.yy);
  r1.x = dot(r2.xyz, float3(0.212672904, 0.715152204, 0.0721750036));
  r1.yw = float2(0, 0);
  r2.xyzw = t9.SampleBias(s0_s, r1.xy, cb0[61].x).xyzw;
  r2.x = saturate(r2.x);
  r0.y = r2.x * r0.y;
  r1.z = cb0[176].x + r3.x;
  r2.xyzw = t6.SampleBias(s0_s, r1.zw, cb0[61].x).xyzw;
  r2.x = saturate(r2.x);
  r0.z = r2.x + r1.z;
  ...
  r1.yzw = cb0[169].zzz * r1.xyz;
  r0.w = floor(r1.y);
  r2.xy = float2(0.5, 0.5) * cb0[169].xy;
  r2.yz = r1.zw * cb0[169].xy + r2.xy;
  r2.x = r0.w * cb0[169].y + r2.y;
  r3.xyzw = t0.SampleLevel(s1_s, r2.xz, 0).xyzw;
  r4.x = cb0[169].y;
  r4.y = 0;
  r1.yz = r4.xy + r2.xz;
  r2.xyzw = t0.SampleLevel(s1_s, r1.yz, 0).xyzw;
  r0.w = r1.x * cb0[169].z + -r0.w;
  ...
  r0.w = 0;
  r1.xyzw = t2.SampleBias(s0_s, r0.xw, cb0[61].x).xyzw;
  r1.x = saturate(r1.x);
  r2.xyzw = t2.SampleBias(s0_s, r0.yw, cb0[61].x).xyzw;
  r1.y = saturate(r2.x);
  r0.xyzw = t2.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  r1.z = saturate(r0.x);
  r0.xyz = float3(0.00390625, 0.00390625, 0.00390625) + r1.xyz;
  r0.w = 0;
  r1.xyzw = t3.SampleBias(s0_s, r0.xw, cb0[61].x).xyzw;
  r1.x = saturate(r1.x);
  r2.xyzw = t4.SampleBias(s0_s, r0.yw, cb0[61].x).xyzw;
  r1.y = saturate(r2.x);
  r0.xyzw = t5.SampleBias(s0_s, r0.zw, cb0[61].x).xyzw;
  r1.z = saturate(r0.x);
  r0.x = max(r1.x, r1.y);
  r0.x = max(r0.x, r1.z);
  r0.x = 1 + -r0.x;
  ...
  float3 hdr_color = r0.xyz;
  bool useSDRLut = (cb0[167].w > 0.0f);

  renodx::lut::Config lut_config = renodx::lut::config::Create(
      s2_s,
      useSDRLut ? cb0[167].w * RENODX_COLOR_GRADE_LUT_STRENGTH : 0,
      RENODX_COLOR_GRADE_LUT_SCALING,
      renodx::lut::config::type::SRGB,
      renodx::lut::config::type::SRGB,
      cb0[167].xyz  // precompute
  );

  r1.xyz = cb0[186].xxx * r0.xyz;
  r2.xyzw = cmp(r1.xxyy < cb0[186].yzyz);
  r3.xyzw = r2.yyyy ? cb0[189].xyzw : cb0[191].xyzw;
  r4.xyzw = r2.yyww ? cb0[190].xyxy : cb0[192].xyxy;
  r3.xyzw = r2.xxxx ? cb0[187].xyzw : r3.xyzw;
  r4.xyzw = r2.xxzz ? cb0[188].xyxy : r4.xyzw;
  r0.x = r0.x * cb0[186].x + -r3.x;
  r0.x = r0.x * r3.z;
  r0.w = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.y * r0.x;
  ...
  r0.x = r0.w ? r0.x : 0;
  r3.x = r0.x * r3.w + r3.y;
  r5.xyzw = r2.wwww ? cb0[189].xyzw : cb0[191].xyzw;
  r2.xyzw = r2.zzzz ? cb0[187].xyzw : r5.xyzw;
  r0.x = r0.y * cb0[186].x + -r2.x;
  r0.x = r0.x * r2.z;
  r0.y = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.w * r0.x;
  ...
  r0.x = r0.y ? r0.x : 0;
  r3.y = r0.x * r2.w + r2.y;
  r0.xy = cmp(r1.zz < cb0[186].yz);
  r1.xyzw = r0.yyyy ? cb0[189].xyzw : cb0[191].xyzw;
  r0.yw = r0.yy ? cb0[190].xy : cb0[192].xy;
  r1.xyzw = r0.xxxx ? cb0[187].xyzw : r1.xyzw;
  r0.xy = r0.xx ? cb0[188].xy : r0.yw;
  r0.z = r0.z * cb0[186].x + -r1.x;
  r0.z = r0.z * r1.z;
  r0.w = cmp(0 < r0.z);
  r0.z = log2(r0.z);
  r0.y = r0.y * r0.z;
...
// Original LUT Sampling
  ...
  if (r0.x != 0) {
    ...
    r1.xyz = cb0[167].zzz * r0.zxy;
    r0.w = floor(r1.x);
    r1.xw = float2(0.5, 0.5) * cb0[167].xy;
    r1.yz = r1.yz * cb0[167].xy + r1.xw;
    r1.x = r0.w * cb0[167].y + r1.y;
    r2.xyzw = t1.SampleLevel(s2_s, r1.xz, 0).xyzw;
    r4.x = cb0[167].y;
    r4.y = 0;
    r1.xy = r4.xy + r1.xz;
    r1.xyzw = t1.SampleLevel(s2_s, r1.xy, 0).xyzw;
    r0.w = r0.z * cb0[167].z + -r0.w;
  ...
  // o0.xyz = saturate(r0.xzw * cb0[192].zzz + r0.yyy);
  o0.xyz = (r0.xzw * cb0[192].zzz + r0.yyy);
  o0.w = 1;
  return;
}
