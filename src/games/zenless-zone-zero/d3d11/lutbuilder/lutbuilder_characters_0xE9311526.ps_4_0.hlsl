...
// Version 3.0 - Character Lutbuilder

// ---- Created with 3Dmigoto v1.4.1 on Wed Jun 17 01:21:31 2026
...
void main(
  ...
  r0.yz = -cb0[174].yz + v1.xy;
  r1.x = cb0[174].x * r0.y;
  r0.x = frac(r1.x);
  r1.x = r0.x / cb0[174].x;
  r0.w = -r1.x + r0.y;
  r0.xyz = r0.xzw * cb0[174].www + float3(-0.386036009, -0.386036009, -0.386036009);
  ...
  r0.xyz = r0.xyz * cb0[180].zzz + float3(0.0275523961, 0.0275523961, 0.0275523961);
  r0.xyz = float3(13.6054821, 13.6054821, 13.6054821) * r0.xyz;
  r0.xyz = exp2(r0.xyz);
  r0.xyz = float3(-0.0479959995, -0.0479959995, -0.0479959995) + r0.xyz;
  ...
  r0.w = saturate(cb0[188].w + r0.w);
  r1.x = 1 + -r0.w;
  r1.yzw = float3(-0.5, -0.5, -0.5) + cb0[188].xyz;
  r1.xyz = r1.xxx * r1.yzw + float3(0.5, 0.5, 0.5);
  r2.xyz = float3(-0.5, -0.5, -0.5) + cb0[189].xyz;
  ...
  r0.w = floor(r1.y);
  r2.xy = float2(0.5, 0.5) * cb0[173].xy;
  r2.yz = r1.zw * cb0[173].xy + r2.xy;
  r2.x = r0.w * cb0[173].y + r2.y;
  ...
  r1.xyz = cb0[190].xxx * r0.xyz;
  r2.xyzw = cmp(r1.xxyy < cb0[190].yzyz);
  r3.xyzw = r2.yyyy ? cb0[193].xyzw : cb0[195].xyzw;
  r4.xyzw = r2.yyww ? cb0[194].xyxy : cb0[196].xyxy;
  r3.xyzw = r2.xxxx ? cb0[191].xyzw : r3.xyzw;
  r4.xyzw = r2.xxzz ? cb0[192].xyxy : r4.xyzw;
  r0.x = r0.x * cb0[190].x + -r3.x;
  r0.x = r0.x * r3.z;
  r0.w = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.y * r0.x;
  ...
  r0.x = r0.w ? r0.x : 0;
  r3.x = r0.x * r3.w + r3.y;
  r5.xyzw = r2.wwww ? cb0[193].xyzw : cb0[195].xyzw;
  r2.xyzw = r2.zzzz ? cb0[191].xyzw : r5.xyzw;
  r0.x = r0.y * cb0[190].x + -r2.x;
  r0.x = r0.x * r2.z;
  r0.y = cmp(0 < r0.x);
  r0.x = log2(r0.x);
  r0.x = r4.w * r0.x;
  ...
  r0.x = r0.y ? r0.x : 0;
  r3.y = r0.x * r2.w + r2.y;
  r0.xy = cmp(r1.zz < cb0[190].yz);
  r1.xyzw = r0.yyyy ? cb0[193].xyzw : cb0[195].xyzw;
  r0.yw = r0.yy ? cb0[194].xy : cb0[196].xy;
  r1.xyzw = r0.xxxx ? cb0[191].xyzw : r1.xyzw;
  r0.xy = r0.xx ? cb0[192].xy : r0.yw;
  r0.z = r0.z * cb0[190].x + -r1.x;
  r0.z = r0.z * r1.z;
  r0.w = cmp(0 < r0.z);
  r0.z = log2(r0.z);
  r0.y = r0.y * r0.z;
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    ...
    if (r0.x != 0) {
      ...
      r1.xyz = cb0[171].zzz * r0.zxy;
      r0.w = floor(r1.x);
      r1.xw = float2(0.5, 0.5) * cb0[171].xy;
      r1.yz = r1.yz * cb0[171].xy + r1.xw;
      r1.x = r0.w * cb0[171].y + r1.y;
      r2.xyzw = t1.SampleLevel(s2_s, r1.xz, 0).xyzw;
      r4.x = cb0[171].y;
      r4.y = 0;
      r1.xy = r4.xy + r1.xz;
      r1.xyzw = t1.SampleLevel(s2_s, r1.xy, 0).xyzw;
      r0.w = r0.z * cb0[171].z + -r0.w;
      r1.xyz = r1.xyz + -r2.xyz;
      r1.xyz = r0.www * r1.xyz + r2.xyz;
      r1.xyz = r1.xyz + -r0.xyz;
      r0.xyz = cb0[171].www * r1.xyz + r0.xyz;
  ...
  // o0.xyz = saturate(r0.xzw * cb0[196].zzz + r0.yyy);
  o0.xyz = (r0.xzw * cb0[196].zzz + r0.yyy);
  o0.w = 1;
  return;
}
