...
// Version 2.8 - General lutbuilder

// ---- Created with 3Dmigoto v1.4.1 on Wed May  6 19:17:24 2026
...
void main(
  ...
  if (RENODX_TONE_MAP_TYPE > 0) {
    ...
    // o0.xyz = ApplyDisplayMap(color_output);
    // o0.xyz = DisplayMap(color_lut_input, color_lut_input_tonemapped, color_output, v1.xy);
    o0.xyz = color_output;
    o0.w = 1.0f;
    return;
  }

  r0.w = cmp(0 < cb0[167].w);
  if (r0.w != 0) {
    ...
    r2.xyz = cb0[167].zzz * r1.zxy;
    r0.w = floor(r2.x);
    r2.xw = float2(0.5, 0.5) * cb0[167].xy;
    r2.yz = r2.yz * cb0[167].xy + r2.xw;
    ...
    r0.w = r1.z * cb0[167].z + -r0.w;
    r2.xyz = r2.xyz + -r3.xyz;
    r2.xyz = r0.www * r2.xyz + r3.xyz;
    r2.xyz = r2.xyz + -r1.xyz;
    r1.xyz = cb0[167].www * r2.xyz + r1.xyz;
  ...
  o0.xyz = saturate(r0.xyz * cb0[192].zzz + r1.xxx);
  o0.w = 1;
  return;
}
