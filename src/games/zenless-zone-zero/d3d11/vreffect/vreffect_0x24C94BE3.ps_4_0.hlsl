...
void main(
  ...
  r3.x = r0.y ? r0.z : r0.w;
  _VR_SourceImage0.xyzw = _VR_SourceImage.SampleBias(s1_s, r1.xy, cb0[61].x).xyzw;

  // r4.xyzw = t1.SampleBias(s1_s, r1.xy, cb0[61].x).xyzw;
  ...
  // r3.xyzw = t1.SampleBias(s1_s, r3.zw, cb0[61].x).xyzw;
  ...
  // r2.xyzw = t1.SampleBias(s1_s, r1.zw, cb0[61].x).xyzw;
  ...
  o0.xyz = renodx::tonemap::UpgradeToneMap(untonemapped.xyz, untonemapped_neutral, r0.xyz);
