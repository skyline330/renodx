...
void main(
  ...
  if (r0.w != 0) {
    ...
    r5.y = 0;
    r2.yz = r5.xy + r3.xz;
    r3.xyzw = t1.SampleLevel(s0_s, r2.yz, 0).xyzw;
  ...
  r0.w = cb0[147].w * cb0[144].z;
  r2.xyz = cb0[147].xyz + -r1.xyz;
  o0.xyz = r0.www * r2.xyz + r1.xyz;
  r0.x = r0.x + r0.y;
  r0.x = r0.x + r0.z;
