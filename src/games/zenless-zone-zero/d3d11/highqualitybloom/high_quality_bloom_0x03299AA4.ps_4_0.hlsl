...
void main(
  ...
  if (r0.w != 0) {
    ...
    r3.yzw = cb0[167].zzz * r3.xyz;
    r0.w = floor(r3.y);
    r4.xy = float2(0.5, 0.5) * cb0[167].xy;
    r4.yz = r3.zw * cb0[167].xy + r4.xy;
    r4.x = r0.w * cb0[167].y + r4.y;
    r5.xyzw = t2.SampleLevel(s0_s, r4.xz, 0).xyzw;
    r6.x = cb0[167].y;
    r6.y = 0;
    r3.yz = r6.xy + r4.xz;
    r4.xyzw = t2.SampleLevel(s0_s, r3.yz, 0).xyzw;
    r0.w = r3.x * cb0[167].z + -r0.w;
  ...
  r0.w = sqrt(r0.w);
  r2.xy = cmp(float2(0.5, 1.5) < cb0[143].zz);
  r3.xz = -cb0[141].xz;
  r3.y = -cb0[142].x;
  r3.xyz = r3.xyz + r0.www;
  r0.w = saturate(cb0[143].x * r3.x);
  r4.z = saturate(cb0[144].x * r3.y);
  r2.z = r0.w * r0.w;
  r2.z = r2.z * r0.w;
  r2.w = r0.w * 6 + -15;
  r2.w = r0.w * r2.w + 10;
  r3.x = r2.z * r2.w;
  r0.w = -r2.z * r2.w + r0.w;
  r4.x = cb0[146].w * r0.w + r3.x;
  r0.w = saturate(cb0[142].z * r3.z);
  r2.zw = r2.yy ? r4.xz : r0.ww;
  r3.xyz = cb0[146].xyz + -cb0[145].xyz;
  r3.xyz = r2.zzz * r3.xyz + cb0[145].xyz;
  r4.xyz = r3.xyz * r1.xyz;
  r0.w = cb0[145].w * r2.w;
  r0.w = cb0[144].z * r0.w;
  r5.xyz = -r3.xyz * r1.xyz + cb0[147].xyz;
  r4.xyz = r0.www * r5.xyz + r4.xyz;
  r4.xyz = r4.xyz + -r1.xyz;
  r4.xyz = cb0[148].xxx * r4.xyz + r1.xyz;
  r3.xyz = r3.xyz * r1.xyz + -r1.xyz;
  r3.xyz = cb0[148].xxx * r3.xyz + r1.xyz;
