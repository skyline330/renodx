...
void main(
  ...
  r0.xyzw = t2.SampleBias(s0_s, v1.xy, cb0[61].x).xyzw;
  r1.xyzw = t1.SampleBias(s1_s, v1.xy, cb0[61].x).xyzw;
  ...
  if (r0.w != 0) {
    ...
    float3 lutted = renodx::lut::Sample(t0, lut_config, color_lut_input_tonemapped);
