...
// ---- Created with 3Dmigoto v1.4.1 on Wed Jun 17 01:21:22 2026
...
void main(
  ...
  r0.xyzw = t3.Sample(s0_s, v1.xy).xyzw;
  r0.x = 255 * r0.z;
  r0.x = round(r0.x);
  r0.x = (int)r0.x;
  r0.x = (uint)r0.x >> 1;
  ...
  r1.xyzw = t4.Sample(s1_s, v1.xy).xyzw;
  ...
  if (r0.w != 0) {
    ...
    if (RENODX_TONE_MAP_TYPE > 0) {
      ...
      r3.xyz = HighQualityBloomLutSample(r3.xyz, t2, s0_s);
      r4.xyz = (r3.xyz);
    } else {
