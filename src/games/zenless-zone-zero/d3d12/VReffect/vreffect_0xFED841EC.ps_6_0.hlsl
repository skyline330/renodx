...
// VR effects - trigger charged shot, intro
...
float4 main(
  ...
  _51.xyz = renodx::tonemap::dice::BT709(_51.xyz, 1.0f, 0.5f);
  ...
  float _165 = select((_51.y < _51.z), 0.0f, 1.0f);
  float _170 = (_165 * (_51.y - _51.z)) + _51.z;
  float _171 = (_165 * (_51.z - _51.y)) + _51.y;
  float _173 = 0.6666666865348816f - _165;
  float _175 = select((_51.x < _170), 0.0f, 1.0f);
  float _182 = (_175 * (_51.x - _170)) + _170;
  float _184 = (_175 * (_170 - _51.x)) + _51.x;
  ...
  float4 _2149 = renodx::draw::InvertIntermediatePass(_VR_SourceImage.Sample(s_linear_repeat_sampler, float2((_RGBSeparateParams0.x + _24), ((_RGBSeparateParams0.y * _27) + _45))));
  _2149.xyz = renodx::tonemap::dice::BT709(_2149.xyz, 1.0f, 0.5f);
  float4 _2164 = renodx::draw::InvertIntermediatePass(_VR_SourceImage.Sample(s_linear_repeat_sampler, float2((_RGBSeparateParams0.z + _24), ((_RGBSeparateParams0.w * _27) + _45))));
  _2164.xyz = renodx::tonemap::dice::BT709(_2164.xyz, 1.0f, 0.5f);
  float4 _2179 = renodx::draw::InvertIntermediatePass(_VR_SourceImage.Sample(s_linear_repeat_sampler, float2((_RGBSeparateParams1.x + _24), ((_RGBSeparateParams1.y * _27) + _45))));
  _2179.xyz = renodx::tonemap::dice::BT709(_2179.xyz, 1.0f, 0.5f);
