...
// ---- Created with 3Dmigoto v1.4.1 on Mon Aug 11 23:50:40 2025
...
void main(
  ...
  float4 v3 : TEXCOORD2,
  float4 v4 : TEXCOORD3,
  nointerpolation int v5 : TEXCOORD4,
  ...
  out float4 o3 : SV_Target3)
{
  ...
  r2.xyzw = instanceVectorBuffer.Load(v5.x).xyzw;
