// Car found in episode 4, caused NaNs when behind DoF

// ---- Created with 3Dmigoto v1.4.1 on Tue Aug 12 00:41:35 2025
...
Texture2D<float4> texture_Texture6 : register(t5);
  ...
  out float4 o3 : SV_Target3)
{
  ...
  r0.z = texture_Texture6.Sample(sampler1_s, r0.zw).y;
  r1.x = r1.x * r1.z;
  ...
  r2.x = texture_Texture6.Sample(sampler1_s, r2.xy).z;
  r2.y = r0.w * r2.x + -r0.w;
  ...
  r1.x = texture_Texture6.Sample(sampler1_s, r1.xz).x;
  r1.x = r2.z * r1.x;
