// Metal wall texture found in episode 6; causes NaNs when behind fog

// ---- Created with 3Dmigoto v1.4.1 on Fri Aug 22 01:04:44 2025
  ...
  out float4 o3 : SV_Target3)
{
  ...
  o2.yzw = float3(0,0,0.00392156979);
