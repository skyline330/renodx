...
// ---- Created with 3Dmigoto v1.4.1 on Fri Aug 22 00:15:08 2025
...
Texture2D<float4> texture_Overlay_Mult : register(t6);
  ...
  out float4 o3 : SV_Target3)
{
  ...
  r1.xyz = texture_Overlay_Mult.Sample(sampler1_s, v4.zw).xyz;
  r2.xy = texture_Specular.Sample(sampler1_s, v4.xy).xy;
  r1.w = external_SpecularSmoothnessScale * r2.y;
  r2.x = external_SpecularScale * r2.x;
  o1.w = sqrt(r2.x);
  r2.x = r1.w * r1.x + -r1.w;
  o0.w = r2.x * external_OverlaySmoothness + r1.w;
  r2.xyzw = texture_Diffuse.Sample(sampler1_s, v4.xy).xyzw;
