...
// ---- Created with 3Dmigoto v1.4.1 on Mon Aug 11 23:03:28 2025
  ...
  out float4 o3 : SV_Target3)
{
  ...
  r0.xyz = texture_Normal.Sample(sampler1_s, v6.xy).xyw;
  r0.x = r0.x * r0.z;
  ...
  r1.z = dot(r0.xyz, v5.xyz);
  r0.x = dot(r1.xyz, r1.xyz);
  r0.x = rsqrt(r0.x);
  r0.xyz = r1.xyz * r0.xxx;
  o0.xyz = r0.xyz * float3(0.5,0.5,0.5) + float3(0.5,0.5,0.5);
  r0.xyz = float3(0.5,0.5,0.5) * r0.xyz;
  r1.xy = texture_Specular.Sample(sampler1_s, v6.xy).xy;
  o0.w = external_SpecularSmoothnessScale * r1.y;
  r1.x = external_SpecularScale * r1.x;
  o1.w = sqrt(r1.x);
  r1.xyz = texture_Diffuse.Sample(sampler1_s, v6.xy).xyz;
  r2.xyzw = texture_Diffuse2.Sample(sampler1_s, v6.zw).xyzw;
  r2.xyz = r2.xyz + -r1.xyz;
  r1.xyz = r2.www * r2.xyz + r1.xyz;
  r2.xy = v6.xy * external_UV_Scale_default.xy + external_UV_Offset_default.xy;
  ...
  o1.xyz = sqrt(r1.xyz);
  o2.yzw = float3(0,0,0);
  r1.x = dot(v2.xy, v7.zw);
  r1.z = dot(v2.zw, v7.zw);
  r1.xy = v7.xy + r1.xz;
