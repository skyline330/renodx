...
// ---- Created with 3Dmigoto v1.4.1 on Fri Aug 22 00:44:56 2025
  ...
  out float4 o3 : SV_Target3)
{
  ...
  o1.xyz = sqrt(r0.xyz);
  r0.xyz = (int3)v5.xxx + int3(1,2,3);
  r1.xyzw = instanceVectorBuffer.Load(r0.z).xyzw;
  r2.w = 1;
  o2.x = dot(r2.xyzw, r1.xyzw);
  o2.yzw = float3(0,0,0);
  r1.xyzw = instanceVectorBuffer.Load(r0.x).xyzw;
  r0.xyzw = instanceVectorBuffer.Load(r0.y).xyzw;
  r0.z = dot(r2.xyzw, r0.xyzw);
  r0.y = dot(r2.xyzw, r1.xyzw);
  r1.xyzw = instanceVectorBuffer.Load(v5.x).xyzw;
